...
//	$grid->render_table("suratmasuk","IdSuratMasuk","TujuanSurat,NoSurat,AsalSurat,Perihal,TglTerima");
	$grid->render_sql("SELECT * FROM suratmasuk WHERE DicatatOleh = '".$KdSatker."' order by TglTerima desc","IdSuratMasuk","DicatatOleh,NoSurat,AsalSurat,Perihal,TglTerima");
