    ...
    if($res=mysql_query($query)){ 
		...
		$exis_no = 0;
			...
			//$nosuratextended = $nosurat." [".$iduser."-".now()."]";
								...
								mysql_query("INSERT INTO suratmasuk( IdSifat, IdKategori, IdKlasifikasi, TglTerima, NoSurat, TglSurat, AsalSurat, Perihal, Lampiran, TujuanSurat, Disposisi, Retensi, Keterangan, DicatatOleh, NoUrut, UserBuat, StatusDisposisi,tl,tl_status,tglawal,tglakhir) 
													  VALUES ('".$IdSifatSurat."', '".$IdKategori."', 
															  '".$IdKlasifikasi."', '".$TglTerima."', '".$NoSurat."', 
															  '".$TglSurat."', '".$AsalSurat."', '".$Perihal."', 
															  '".$Lampiran."', '".$TujuanSurat."', '".$Disposisi."',
															  '".$Retensi."', '".$Keterangan."', '".$DicatatOleh."', '".$exis_no."','".$IdUser."', 1, '".$tl."', '".$tl_status."', '".$tglawal."', '".$tglakhir."')") or  die(mysql_error());
								} else {
								mysql_query("INSERT INTO suratmasuk( IdSifat, IdKategori, IdKlasifikasi, TglTerima, NoSurat, TglSurat, AsalSurat, Perihal, Lampiran, TujuanSurat, Disposisi, Retensi, Keterangan, DicatatOleh, NoUrut, UserBuat,tl,tl_status,tglawal,tglakhir) 
													  VALUES ('".$IdSifatSurat."', '".$IdKategori."', 
															  '".$IdKlasifikasi."', '".$TglTerima."', '".$NoSurat."', 
															  '".$TglSurat."', '".$AsalSurat."', '".$Perihal."', 
															  '".$Lampiran."', '".$TujuanSurat."', '".$Disposisi."',
															  '".$Retensi."', '".$Keterangan."', '".$DicatatOleh."', '".$exis_no."','".$IdUser."', '".$tl."', '".$tl_status."', '".$tglawal."', '".$tglakhir."')") or  die(mysql_error());
								}				
						// upload surat
		if ($NoSurat != "")
		{
