...
document.getElementById('status2').checked = true;}
               ...
               <tr> 
                  ...
                  <label>
                    <input type="radio" name="status" value="0" id="no" checked="checked">
                    Tidak</label>
	          ...
	          <script type="text/javascript">
                ...
                <tr> 
                  ...
                  <td>
                    <p>
                  <label>
                    <input type="radio" name="statusx" value="1" id="status1">
                    Sudah</label>
                 
                  <label>
                    <input type="radio" name="statusx" value="0" id="status2" >
                    Belum</label>
