    ...
    if($res=mysql_query($query)){ 
		...
		$exis_no = 0;
			...
			//$nosuratextended = $nosurat." [".$iduser."-".now()."]";
								...
								mysql_query("INSERT INTO suratmasuk( IdSifat, IdKategori, IdKlasifikasi, TglTerima, NoSurat, TglSurat, AsalSurat, Perihal, Lampiran, TujuanSurat, Disposisi, Retensi, Keterangan, DicatatOleh, NoUrut, UserBuat, StatusDisposisi,tl_status,tglawal,tglakhir) 
													  VALUES ('".$IdSifatSurat."', '".$IdKategori."', 
															  '".$IdKlasifikasi."', '".$TglTerima."', '".$NoSurat."', 
															  '".$TglSurat."', '".$AsalSurat."', '".$Perihal."', 
															  '".$Lampiran."', '".$TujuanSurat."', '".$Disposisi."',
															  '".$Retensi."', '".$Keterangan."', '".$DicatatOleh."', '".$exis_no."','".$IdUser."', 0, '".$tl_status."', '".$tglawal."', '".$tglakhir."')") or  die(mysql_error());
								} else {
								mysql_query("INSERT INTO suratmasuk( IdSifat, IdKategori, IdKlasifikasi, TglTerima, NoSurat, TglSurat, AsalSurat, Perihal, Lampiran, TujuanSurat, Disposisi, Retensi, Keterangan, DicatatOleh, NoUrut, UserBuat,tl_status,tglawal,tglakhir) 
													  VALUES ('".$IdSifatSurat."', '".$IdKategori."', 
															  '".$IdKlasifikasi."', '".$TglTerima."', '".$NoSurat."', 
															  '".$TglSurat."', '".$AsalSurat."', '".$Perihal."', 
															  '".$Lampiran."', '".$TujuanSurat."', '".$Disposisi."',
															  '".$Retensi."', '".$Keterangan."', '".$DicatatOleh."', '".$exis_no."','".$IdUser."',  '".$tl_status."', '".$tglawal."', '".$tglakhir."')") or  die(mysql_error());
								}				
						// upload surat
		if ($NoSurat != "")
		{
...
document.getElementById('date_until').value = '';
...
document.getElementById('a_triggerIMG').value = '';
document.getElementById('a_triggerIMG').disabled = true;
document.getElementById('b_triggerIMG').value = '';
document.getElementById('b_triggerIMG').disabled = true}
...
document.getElementById('status2').checked = true;}
          ...
          <!--     <tr> 
                  ...
                  <td>
                    <p>
                  <label>
                    <input type="radio" name="tl" value="1" id="yes">
                    Ya</label>
                 
                  <label>
                    <input type="radio" name="tl" value="0" id="no" >
                    Tidak</label>
                ...
                <tr> 
                  ...
                  <td>
                    <p>
                  <label>
                    <input type="radio" name="tl_status" value="1" id="status1">
                    Sudah</label>
                 
                  <label>
                    <input type="radio" name="tl_status" value="0" id="status2"  >
                    Belum</label>
                    
                    <label>
                    <input type="radio" name="tl_status" value="2" id="status3"  >
        ...
        <tr>
			...
			<td>			
				...
				<div class="button2-left">
					<div class="next">
						<a onclick="Btn_Submit('lokasifile')">Simpan</a>
					</div>
				</div>
				<div class="clr"></div>
