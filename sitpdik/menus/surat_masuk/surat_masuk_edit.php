...
if ($TglSurat == "") {
	...
	if ($NoSurat == "" or $NoSurat == "-" or $NoSurat == "--" or $NoSurat == "---") {
		$bError		 = true;
		$_SESSION['errmsg']	 .= ". Masukkan NoSurat dengan benar<br />";
	}
	if ($TglTerima == "") {
		$bError		 = true;
		$_SESSION['errmsg']	 .= ". Masukkan Tanggal Terima Surat dengan benar<br />";
	}
	if ($AsalSurat == "") {
		$bError		 = true;
	...
	if ($TujuanSurat == "") {
		$bError		 = true;
		$_SESSION['errmsg']	.= ". Masukkan Tujuan Surat dengan benar<br />";
	}
	if ($IdSifatSurat == "") {
		$bError		 = true;
