<?php
	...
	$suratmasukviewlink = 82;
	$suratmasukeditlink = 83;
	//$memoviewlink = 81;
	
	
	if (@$_POST['c'])
	{
		$sql = sql_select("suratmasuk", "*", "DicatatOleh = '".@$_SESSION['xunit_'.$session_name]."' AND StatusDisposisi = 0 AND StatusDistribusi = 0 AND Perihal LIKE '%".$c."%'", "TglTerima DESC");
	}
	
	else
	{
		$sql = sql_select("suratmasuk", "*", "DicatatOleh = '".@$_SESSION['xunit_'.$session_name]."' AND StatusDisposisi = 0 AND StatusDistribusi = 0", "TglTerima DESC");
	}
...
<?php
  ...
  ?>
            ...
            <th rowspan="2" colspan="3" width="6%" nowrap="nowrap">
            	<a href="index.php?p=<?php echo enkripsi($addlinksurat); ?>"><img src="css/images/add-icon.png" width="16" height="16" /> Tambah</a>
            </th>
		</tr>
	</thead>
	<tbody><?php
			...
			while ($list = mysql_fetch_array($olist))
			{
             ...
             <!--  <td class="tablebody">
                  <?=$disposisi[$i] ?>
					...
					<td  align="center">
				<a href="index.php?p=<?php echo enkripsi($suratmasukviewlink."&q=".$id[$i]); ?>" title="Lihat">
							<img src="css/images/view.gif" border="0" width="16" height="16" /> 
					  </a>
                    </td>
    <?php 
...
?>              
                    <td align="center">
						<a href="index.php?p=<?php echo enkripsi($suratmasukeditlink."&q=".$id[$i]); ?>" title="Edit Status Tindak Lanjut">
