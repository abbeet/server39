<?php
	...
	if (@$_POST['c'])
	{
		$sql = sql_select("suratkeluar", "*", "TujuanSurat LIKE '%".$c."%' OR Perihal LIKE '%".$c."%' OR NoSurat LIKE '%".$c."%'" ,"WaktuBuat DESC");
	}
	
	else
	{
		$sql = sql_select("suratkeluar", "*", "AsalSurat = '$usernamex'", "WaktuBuat DESC");
	}
