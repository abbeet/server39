...
//	$grid->render_table("suratmasuk","IdSuratMasuk","TujuanSurat,NoSurat,AsalSurat,Perihal,TglTerima");
	$grid->render_sql("SELECT * FROM suratkeluar WHERE DicatatOleh = '".$KdSatker."' order by TglTerima desc","IdSuratKeluar","DicatatOleh,NoSurat,AsalSurat,Perihal,TglTerima");
