<?php
	...
	if (@$_POST['c'])
	{
		$sql = sql_select("klasifikasisurat", "*", "IdKlasifikasi LIKE '%".$c."%' OR NmKlasifikasi LIKE '%".$c."%'", "IdKlasifikasi");
	}
	
	else
	{
		$sql = sql_select("klasifikasisurat", "*", "", "IdKlasifikasi");
	}
...
<table class="adminlist" cellpadding="1">
	...
	<tbody><?php
		...
		else
		{
			...
			{
				$id[$i]		= $list['IdKlasifikasi'];
				$nama[$i]	= $list['NmKlasifikasi'];
