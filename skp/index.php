	...
	<body id="minwidth-body">
		...
		<div id="header-box">
			<div id="module-status">
				<span class="loggedin-users">Selamat datang <b><?php echo $xusername ?> 
				<font color="green">[Online users: <?php echo $user_online ?>]</font></b></span>
		...
		<div id="content-box">
			<div class="border">
				<div class="padding">
					...
					<span class="style5"><strong>Tahun <?php echo $xth ?></strong></span><br />
					<?php
