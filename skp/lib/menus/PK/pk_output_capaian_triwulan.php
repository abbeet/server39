...
<table width="840" cellpadding="1" class="adminlist">
  <thead>
    <tr> 
      ...
      <th width="5%" rowspan="2">Unit Kerja</th>
      <th colspan="2">Kode</th>
      <th rowspan="2">Nama Satker dan Kegiatan /<br>
        Output</th>
      <th colspan="4">% Capaian/Target Triwulan </th>
...
?>
    <tr class="<?php echo $class ?>"> 
      ...
      <td width="42%" align="left"><?php echo nm_output($kdgiat.$List_kak_output['kdoutput']) ?></td>
      <td align="center"><?php if( $List['persen_capaian_b3'] <> 0 ){ ?><?php echo $List['persen_capaian_b3'].' %' ?><?php }?></td>
      <td align="center"><?php if( $List['persen_capaian_b6'] <> 0 ){ ?><?php echo $List['persen_capaian_b6'].' %' ?><?php }?></td>
      <td align="center"><?php if( $List['persen_capaian_b9'] <> 0 ){ ?><?php echo $List['persen_capaian_b9'].' %' ?><?php }?></td>
      <td align="center"><?php if( $List['persen_capaian_b12'] <> 0 ){ ?><?php echo $List['persen_capaian_b12'].' %' ?><?php }?></td>
      <td align="center"> <a href="<?php echo $ed[$k] ?>&amp;q=<?php echo $List['id'] ?>&amp;o=<?php echo $List_kak_output['id'] ?>&pagess=<?php echo $pagess ?>" title="Edit Kriteria dan Ukuran Keberhasilan Output"> 
    ...
    <tr class="<?php echo $class ?>">
	  ...
	  <?php echo 'Target Tw.I : '.$List['capaian_b3'] ?><br />
	  <?php echo 'Target Tw.II : '.$List['capaian_b6'] ?><br />
	  <?php echo 'Target Tw.III : '.$List['capaian_b9'] ?><br />
	  <?php echo 'Target Tw.IV : '.$List['capaian_b12'] ?></td>
    </tr>
    <?php
		}
		}
