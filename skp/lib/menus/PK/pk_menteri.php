<?php
	...
	$sql = "select THANG,sum(JUMLAH) as pagu_dept from d_item WHERE THANG='$th' group by KDDEPT";
...
?><?php echo '<strong> Tahun Anggaran : '.$th.'</strong>' ?>
<table width="921" cellpadding="1" class="adminlist">
	...
	<tfoot>
		<tr>
			<td colspan="4"><?php echo '<strong> Jumlah Anggaran Tahun '.$th.' Rp.  '.number_format($Dept['pagu_dept'],"0",",",".").',- </strong>' ?></td>
		</tr>
	</tfoot>
</table>
