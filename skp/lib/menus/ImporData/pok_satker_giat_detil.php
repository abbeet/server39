...
<table width="738" cellpadding="1" class="adminlist">
  <thead>
    <tr> 
      <th>Kode APBN</th>
      <th colspan="5">Nama Kegiatan/ output<br>
...
?>
    ...
    <?php 
	$sql = "select NMITEM,VOLKEG,SATKEG,JUMLAH,HARGASAT from $table WHERE THANG='$th' and KDSATKER='$kdsatker' and KDGIAT='$kdgiat' and KDOUTPUT='$Output[KDOUTPUT]' and KDSOUTPUT='$SOutput[KDSOUTPUT]' and KDKMPNEN='$Kmpnen[KDKMPNEN]' and KDSKMPNEN='$SKmpnen[KDSKMPNEN]' and KDAKUN='$Akun[KDAKUN]'";
