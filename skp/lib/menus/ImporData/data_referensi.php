...
?>
<table width="737" cellpadding="1" class="adminlist">
  <thead>
    <tr> 
      <th>Kode APBN</th>
      <th>Lembaga / Program / Kegiatan </th>
  ...
  <tbody>
    ...
    <tr class="<?php echo $class ?>"> 
      ...
      <td width="76%" align="left"><strong><?php echo  $col[1][$k] ?></strong></td>
	...
	?>
    <tr class="<?php echo $class ?>"> 
      <td align="center" valign="top"><?php echo $Satker['KdGiat'] ?></td>
      <td align="left" valign="top"><?php echo $Satker['NmGiat'] ?></td>
