<?php
	...
	<table width="721" cellspacing="1" class="admintable">
		...
		<tr>
		  <td colspan="2" class="key" align="left"><div align="left"><strong>Mendukung IKU Kementerian : 
          <input name="<?php echo $field[11] ?>" type="radio" value="1" <?php if($value[11]=='1'){ echo 'cheched'; } ?>/>
&nbsp;Ya&nbsp;&nbsp;&nbsp;
          <input name="<?php echo $field[11] ?>" type="radio" value="0" <?php if($value[11]=='0'){ echo 'cheched'; } ?>/>
&nbsp;Tidak&nbsp;&nbsp;&nbsp;
		  </strong></div></td>
	  </tr>
		<tr>
		  ...
		  <td>2010&nbsp;<input type="text" name="<?php echo $field[5] ?>" size="10" value="<?php echo $value[5] ?>" />&nbsp;
			  ...
			  2014&nbsp;<input type="text" name="<?php echo $field[9] ?>" size="10" value="<?php echo $value[9] ?>" />&nbsp; </td>
	  </tr>
		<tr>
			<td>&nbsp;</td>
			<td>			
