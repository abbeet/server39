<?php
	...
	$query = "SELECT COUNT(*) as num FROM $table WHERE KdGiat LIKE '%$cari%'";
	...
	$oList = mysql_query("SELECT * FROM $table WHERE KdGiat LIKE '%$cari%' ORDER BY kdgiat LIMIT $start, $limit");
		...
		if ($count == 0) { ?>
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
					...
					<td align="center"><?php echo unit_giat($col[2][$k]) ?></td>
					<td align="center">
