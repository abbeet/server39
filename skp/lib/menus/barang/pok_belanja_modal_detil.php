...
<table width="738" cellpadding="1" class="adminlist">
  ...
  <tbody>
    ...
    <?php 
	$sql = "select KDOUTPUT, sum(JUMLAH) as pagu_output from $table WHERE THANG='$th' and kdsatker = '$kdsatker' and KDGIAT='$kdgiat' and KDOUTPUT='$kdoutput' and left(KDAKUN,2) = '53' group by KDOUTPUT";
...
?>
    ...
    <?php 
	$sql = "select KDSOUTPUT, sum(JUMLAH) as pagu_soutput from $table WHERE THANG='$th' and kdsatker = '$kdsatker' and KDGIAT='$kdgiat' and KDOUTPUT='$kdoutput' and left(KDAKUN,2) = '53' group by KDSOUTPUT";
    ...
    <?php 
	$sql = "select KDKMPNEN, sum(JUMLAH) as pagu_kmpnen from $table WHERE THANG='$th' and kdsatker = '$kdsatker' and KDGIAT='$kdgiat' and KDOUTPUT='$kdoutput' and KDSOUTPUT='$SOutput[KDSOUTPUT]' and left(KDAKUN,2) = '53' group by KDKMPNEN";
    ...
    <?php 
	$sql = "select KDSKMPNEN, sum(JUMLAH) as pagu_skmpnen from $table WHERE THANG='$th' and kdsatker = '$kdsatker' and KDGIAT='$kdgiat' and KDOUTPUT='$kdoutput' and KDSOUTPUT='$SOutput[KDSOUTPUT]' and KDKMPNEN='$Kmpnen[KDKMPNEN]' and left(KDAKUN,2) = '53' group by KDSKMPNEN";
    ...
    <?php 
	$sql = "select KDAKUN, sum(JUMLAH) as pagu_akun from $table WHERE THANG='$th' and kdsatker = '$kdsatker' and KDGIAT='$kdgiat' and KDOUTPUT='$kdoutput' and KDSOUTPUT='$SOutput[KDSOUTPUT]' and KDKMPNEN='$Kmpnen[KDKMPNEN]' and KDSKMPNEN='$SKmpnen[KDSKMPNEN]' and left(KDAKUN,2) = '53' group by KDAKUN order by KDAKUN";
