<?php
	...
	$query = "SELECT COUNT(*) as num FROM $table WHERE kdoutput LIKE '%$cari%' OR nmoutput LIKE '%$cari%'";
	...
	$oList = mysql_query("SELECT * FROM $table WHERE kdoutput LIKE '%$cari%' OR nmoutput LIKE '%$cari%' ORDER BY kdgiat,kdoutput LIMIT $start, $limit");
		...
		if ($count == 0) { ?>
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
					...
					<td align="left"><?php if($col[3][$k] <> $col[3][$k-1]){?><?php echo unit_giat($col[3][$k]) ?><?php }?></td>
					<td align="center"><?php if($col[3][$k] <> $col[3][$k-1]){?><?php echo $col[3][$k]; ?><?php }?></td>
					<td align="left"><?php if($col[3][$k] <> $col[3][$k-1]){?><?php echo nm_giat($col[3][$k]) ?><?php }?></td>
