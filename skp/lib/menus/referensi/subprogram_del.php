...
<table width="551" cellspacing="1" class="admintable">
	<tr>
		<td width="115" class="key">id</td>
		<td width="427"><input type="text" size="5" readonly="readonly" value="<?php echo $value[0] ?>" /></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="key">Sub Program</td>
		<td><textarea readonly="readonly" cols="60" rows="3"><?php echo $value[2] ?></textarea></td>
	</tr>
	<tr>
	  <td class="key">Outcome</td>
	  <td><textarea readonly="readonly" cols="60" rows="3"><?php echo $value[3] ?></textarea></td>
  </tr>
	<tr>
	  <td class="key">Program</td>
	  <td><textarea readonly="readonly" cols="60" rows="3"><?php echo nm_program($value[4].$value[5].$value[6]) ?></textarea></td>
  </tr>
	<tr>
		<td>&nbsp;</td>
		<td>
