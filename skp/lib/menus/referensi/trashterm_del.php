...
<table class="admintable" cellspacing="1">
	...
	<tr>
		...
		<td class="key">Bahasa</td>
		  <td><select name="<?php echo $field[2] ?>" disabled>
				<option value="id" <?php echo map($value[2],"id") ?>>Indonesia</option>
				<option value="en" <?php echo map($value[2],"en") ?>>Inggris</option>
			</select></td>
	</tr>
