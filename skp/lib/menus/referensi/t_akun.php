<?php
	...
	$query = "SELECT COUNT(*) as num FROM $table WHERE KDAKUN LIKE '%$cari%' OR NMAKUN LIKE '%$cari%' ";
	...
	$oList = mysql_query("SELECT * FROM $table WHERE KDAKUN LIKE '%$cari%' OR NMAKUN LIKE '%$cari%' ORDER BY KDAKUN LIMIT $start, $limit");
...
<div align="right">
	<form action="" method="get">
		...
		<a href="index.php?p=164">Reset</a>
	</form>
</div><br />
<table width="30%" cellpadding="1" class="adminlist">
  <thead>
    <tr> 
      <th width="11%">No.</th>
      <th width="14%">Kode</th>
