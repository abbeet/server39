		...
		if ($count == 0) { ?>
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
					...
					<td align="left"><?php if($col[3][$k].$col[4][$k].$col[5][$k] <> $col[3][$k-1].$col[4][$k-1].$col[5][$k-1]){?><?php echo nm_program($col[3][$k].$col[4][$k].$col[5][$k]) ?><?php }?></td>
					<td align="center"><?php echo $col[1][$k] ?></td>
					<td align="left"><?php echo $col[2][$k] ?></td>
					<td align="left"><?php echo nm_unit($col[6][$k]) ?></td>
