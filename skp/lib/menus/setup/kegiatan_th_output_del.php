...
<table width="551" cellspacing="1" class="admintable">
	...
	<tr>
		...
		<td width="427"><input type="text" size="60" readonly="readonly" value="<?php echo nm_giat($value[3]) ?>" /></td>
	</tr>
	<tr>
		<td class="key">Output</td>
		<td><textarea readonly="readonly" cols="60" rows="3"><?php echo nm_output($value[3].$value[4]) ?></textarea></td>
	</tr>
