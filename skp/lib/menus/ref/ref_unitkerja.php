<?php
	...
	$query = "SELECT COUNT(*) as num FROM $table WHERE NmUnit LIKE '%$cari%' OR KdUnit LIKE '%$cari%' OR TuPok LIKE '%$cari%' OR KdUnit LIKE '%$cari%' OR SktUnit LIKE '%$cari%' ";
	...
	$oList = mysql_query("SELECT * FROM $table WHERE NmUnit LIKE '%$cari%' OR KdUnit LIKE '%$cari%' OR TuPok LIKE '%$cari%' OR KdUnit LIKE '%$cari%' OR SktUnit LIKE '%$cari%' ORDER BY KdUnit LIMIT $start, $limit");
...
<div align="right">
	<form action="" method="get">
		...
		<a href="index.php?p=233">Reset</a>
	</form>
</div><br />
				...
				<tr class="<?php echo $class ?>">
					...
					<td align="left"><?php 
						...
						{ ?>
							...
							$sql = "SELECT * FROM kd_unitkerja_fungsi WHERE KdUnit = '".$col[1][$k]."'"." order by KdFungsi";
