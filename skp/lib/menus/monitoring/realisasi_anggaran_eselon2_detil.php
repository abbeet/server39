...
?>
    <tr> 
      <td width="14%" rowspan="2" align="center"><?php echo $kdgiat ?>	  </td>
      <td width="64%" rowspan="2" align="left"><?php echo nm_giat($kdgiat) ?></td>
      ...
      <td align="right" valign="top" class="row6"><?php echo number_format($Giat['jun']/1000,"0",",",".") ?></td>
...
?>
    <tr>
      ...
      <td align="right" class="row6"><font color="#FF0000"><?php echo number_format($Output['pagu_output']/1000,"0",",",".") ?></td>
