...
<table class="admintable" cellspacing="1">
	...
	<tr>
		...
		<td><input type="text" size="40" readonly="readonly" value="<?php echo $value['2'] ?>" /></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="key">Ditampilkan</td>
		<td><input type="text" size="40" readonly="readonly" value="<?php if ($value['5'] == 1) echo "Ya"; else echo "Tidak" ?>" /></td>
	</tr>
	<tr>
		<td class="key">Level Akses</td>
		<td><input type="text" size="40" readonly="readonly" value="<?php echo $value['6'] ?>" /></td>
	</tr>
	<tr>
		<td class="key">Letak File</td>
		<td><input type="text" size="40" readonly="readonly" value="<?php echo $value['7'] ?>" /></td>
	</tr>
	<tr>
		<td class="key">Urutan</td>
		<td><input type="text" size="40" readonly="readonly" value="<?php echo $value['8'] ?>" /></td>
	</tr>
	<tr>
		<td>&nbsp;</td>
		<td>
