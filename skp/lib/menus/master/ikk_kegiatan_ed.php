...
<form action="index.php?p=<?php echo $_GET['p'] ?>" method="post" name="form">
  ...
  <table cellspacing="1" class="admintable">
    ...
    <tr>
      ...
      <td>
			<input name="masuk_renja" type="radio" value="1" <?php if ($value[10] == 1) echo "checked=\"checked\""; ?>/>&nbsp; Ya
			<input name="masuk_renja" type="radio" value="0" <?php if ($value[10] == 0) echo "checked=\"checked\""; ?>/>&nbsp; Tidak
		</td>
    </tr>
    <tr> 
