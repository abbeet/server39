  ...
  <tbody>
    ...
    <tr> 
      ...
      <td align="right"><b> 
        ...
        <?php
					...
					else echo number_format($row2['jml_anggaran'],"0",",","."); ?>
        </b> </td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr class="<?php echo $class ?>"> 
      ...
      <td align="left"><a href="index.php?p=119&u=<?php echo $col[2][$k]; ?>&g=<?php echo $col[3][$k]; ?>&t=<?php echo $col[1][$k]; ?>" title="Edit"> 
        Output >> </a></td>
      <td align="center" valign="top"> <a href="<?php echo $ed[$k] ?>" title="Edit"> <img src="css/images/edit_f2.png" border="0" width="16" height="16">	
        </a> </td>
      <td align="center"> <a href="<?php echo $del[$k] ?>" title="Delete"> <img src="css/images/stop_f2.png" border="0" width="16" height="16">	
        </a> </td>
    </tr>
    <?php
			}
