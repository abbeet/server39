	...
	<table cellspacing="1" class="admintable">
      ...
      <td> <select name="select" disabled="disabled">
          <?php
					...
					{ ?>
          <option value="<?php echo $UnitKerja['kdunit']; ?>" <?php if ($u == $UnitKerja['kdunit']) echo "selected"; ?>><?php echo $UnitKerja['nama_unit_kerja']; ?></option>
          <?php
					} ?>
        </select> 
		...
		{ ?>
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
					...
					<td align="center">
						<a href="index.php?p=110&u=<?php echo $u; ?>&q=<?php echo $col[0][$k]; ?>" title="Delete">
