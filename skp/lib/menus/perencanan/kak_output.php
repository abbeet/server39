<?php
	...
	$prn_link = "index.php?p=menus/perencanaan/kak_kegiatan_prn";
  ...
  <tbody>
    ...
    <tr class="<?php echo $class ?>"> 
      ...
      <td align="left"> <strong> 
        ...
        <?php echo nm_unit($col[2][$k]) ?> 
        <?php } ?>
        </strong></td>
      <td align="center"><strong><?php echo $col[3][$k] ?>&nbsp;</strong></td>
      <td colspan="2" align="left"><strong><?php echo nm_giat($col[3][$k]) ?></strong></td>
      <td align="right"><strong><?php echo number_format($col[7][$k],"0",",",".") ?></strong></td>
      <td align="left"><strong><?php echo pjawaqb_giat($col[1][$k],$col[3][$k]) ?>&nbsp;</strong></td>
      <td align="right">&nbsp;</td>
	...
	$th = $col[1][$k];
	$kdgiat = $col[3][$k];
	$oList_kak_output = mysql_query("SELECT * FROM thbp_kak_output WHERE th = '$th' AND kdgiat = '$kdgiat' ");
...
?>
    <tr class="<?php echo $class ?>"> 
      ...
      <td width="47%" align="left"><?php echo nm_output($kdgiat.$List_kak_output['kdoutput']) ?></td>
      <td width="9%" align="center"><?php echo $List_kak_output['volume'].' '.nm_satuan($List_kak_output['kdsatuan']) ?>&nbsp;</td>
      <td align="right"><?php echo number_format($List_kak_output['jml_anggaran'],"0",",",".") ?></td>
      <td align="left"><?php echo $List_kak_output['id_pjawab'] ?></td>
      <?php 
	...
	?>
      <td align="right">&nbsp;</td>
      <td align="center"> <a href="<?php echo $ed[$k] ?>&q=<?php echo $List_kak_output_uk['id'] ?>&o=<?php echo $List_kak_output['id'] ?>" title="Edit KAK Output"> 
        <img src="css/images/edit_f2.png" border="0" width="16" height="16"> </a> </td>
      <td align="center"> <a href="menus/perencanaan/kak_output_prn.php?q=<?php echo $List_kak_output_uk['id'] ?>&k=<?php echo $col[0][$k] ?>&o=<?php echo $List_kak_output['id'] ?>" title="Cetak KAK Kegiatan" target="_blank"> 
