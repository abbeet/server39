  ...
  <tbody>
    ...
    <tr class="<?php echo $class ?>"> 
      ...
      <td align="center"><a href="index.php?p=126&u=<?php echo $col[2][$k]; ?>&g=<?php echo $col[3][$k]; ?>&t=<?php echo $col[1][$k]; ?>" title="Edit">
						...
						<a href="index.php?p=133&u=<?php echo $col[2][$k]; ?>&g=<?php echo $col[3][$k]; ?>&t=<?php echo $col[1][$k]; ?>" title="Edit">
								Alat >>
						</a></td>
      <td align="right">&nbsp;</td>
      <?php 
...
?>
      ...
      <td width="4%" align="center"> <a href="menus/perencanaan/kak_kegiatan_prn.php?q=<?php echo $List_kak_uk['id'] ?>&id=<?php echo $col[0][$k] ?>" title="Cetak KAK Kegiatan" target="_blank"> 
