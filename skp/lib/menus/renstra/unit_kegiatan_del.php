...
<table width="338" cellspacing="1" class="admintable">
  <tr> 
    ...
    <td width="249"><input type="text" size="5" readonly="readonly" value="<?php echo $value[0] ?>" /></td>
  </tr>
  <tr>
    <td class="key">Unit Kerja</td>
    <td><textarea readonly="readonly" cols="60" rows="3"><?php echo nm_unit($value[7]) ?></textarea></td>
  </tr>
  <tr> 
