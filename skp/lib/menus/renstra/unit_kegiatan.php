<?php
	...
	$oList = mysql_query("SELECT * FROM $table WHERE kdgiat LIKE '%$cari%' OR nmgiat LIKE '%$cari%' ORDER BY kdunitkerja,kdgiat LIMIT $start, $limit");
...
<div align="right">
	<form action="" method="get">
		...
		<a href="http://183.91.67.3/sipristek/index.php?p=165">Reset</a>
	</form>
</div><br />
		...
		if ($count == 0) { ?>
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
					...
					<td align="left"><?php if($col[7][$k] <> $col[7][$k-1]){?><?php echo nm_unit($col[7][$k]) ?><?php }?></td>
					<td align="center"><?php echo $col[2][$k] ?></td>
					<td align="left"><?php echo $col[3][$k] ?></td>
					<td align="left"><?php if($col[4][$k].$col[5][$k].$col[6][$k] <> $col[4][$k-1].$col[5][$k-1].$col[6][$k-1]){?><?php echo nm_program($col[4][$k].$col[5][$k].$col[6][$k]) ?><?php }?></td>
