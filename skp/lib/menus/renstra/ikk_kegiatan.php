<?php
	...
	$oList = mysql_query("SELECT * FROM $table WHERE ikk LIKE '%$cari%' ORDER BY kdunitkerja,kdgiat,kdoutput LIMIT $start, $limit");
...
<div align="right">
	<form action="" method="get">
		...
		<a href="http://183.91.67.3/sipristek/index.php?p=44">Reset</a>
	</form>
</div><br />
...
<table width="652" cellpadding="1" class="adminlist">
  <thead>
    <tr> 
      ...
      <th rowspan="2" width="6%">Kode Kegiatan</th>
      <th rowspan="2" width="14%">Nama Kegiatan</th>
      <th rowspan="2" width="6%">Kode Output</th>
      <th rowspan="2" width="15%">Nama Output</th>
      <th width="18%" rowspan="2">Indikator</th>
      <th colspan="5">Target</th>
      <th width="10%" rowspan="2">Unit</th>
      <th colspan="2" rowspan="2" width="6%">Aksi</th>
    </tr>
    <tr> 
      <th width="6%">2010</th>
      <th width="6%">2011</th>
  ...
  <tbody>
    ...
    <tr class="<?php echo $class ?>"> 
      ...
      <td align="left"><?php echo nm_output($col[2][$k].$col[3][$k]) ?></td>
