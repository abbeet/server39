		...
		if ($count == 0) { ?>
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
					...
					<td align="left" valign="top"><?php if($col[1][$k] <> $col[1][$k-1]){?><?php echo nm_program('04201'.$col[1][$k]) ?><br />
					<strong>Outcome :</strong><br /><?php echo outcome_program('04201'.$col[1][$k]) ?>
					<?php }?></td>
					<td align="left" valign="top"><?php if($col[1][$k].$col[2][$k] <> $col[1][$k-1].$col[2][$k-1]){?><?php echo nm_subprogram('04201'.$col[1][$k].$col[2][$k]) ?><br /><strong>Outcome :</strong><br /><?php echo outcome_subprogram('04201'.$col[1][$k].$col[2][$k]) ?><br /><strong>Deputi :</strong><br /><?php echo deputi_subprogram($col[2][$k]) ?><?php }?></td>
					<td align="center" valign="top"><?php echo $col[3][$k] ?></td>
					<td align="left" valign="top"><?php echo $col[4][$k] ?><br /><strong>Alasan :</strong><br /><?php echo $col[10][$k] ?></td>
					...
					<td align="center" valign="top"><?php if ($col[11][$k] == 1) { ?>
