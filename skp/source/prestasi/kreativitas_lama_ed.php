<?php
	...
	if (isset($form)) {		
		if ($err != true) {
			...
			if ($q == "") {
				...
				<meta http-equiv="refresh" content="0;URL=index.php?p=455&id_skp=<?php echo $id_skp ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>&sw=<?php echo $sw ?>"><?php
				exit();
			} 
			else {
				// UPDATE
	...
	<form action="index.php?p=455&id_skp=<?php echo $id_skp ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>&sw=<?php echo $sw ?>" method="post" name="form">
...
<table width="58%" cellpadding="1" class="adminlist">
	...
	<tbody><?php
		if ($count == 0) { ?>
		  ...
		  <a href="index.php?p=455&q=<?php echo $col[0][$k] ?>&id_skp=<?php echo $id_skp ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>&sw=<?php echo $sw ?>" title="Edit">
			  <img src="css/images/edit_f2.png" border="0" width="16" height="16"></a>			  	  </td>
				  <td align="center" valign="top">
		  <a href="index.php?p=456&q=<?php echo $col[0][$k] ?>&id_skp=<?php echo $id_skp ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>&sw=<?php echo $sw ?>" title="Hapus">
