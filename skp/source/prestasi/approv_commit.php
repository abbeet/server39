<?php	
	...
	{	
		...
		mysql_query("UPDATE mst_skp SET is_approved_awal = '0', tgl_approved_awal = '0000-00-00', pesan='$pesan' WHERE id = '$id_skp'");
	}
	if ( $status == '1' and $sw == '0' )
	{
		...
		$pesan_lama = $_POST['pesan_lama'];
		$pesan = $pesan_baru . $pesan_lama;
		mysql_query("UPDATE mst_skp SET is_approved_awal = '1', tgl_approved_awal = '$tgl', pesan='$pesan' WHERE id = '$id_skp'");
	}
