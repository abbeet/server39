<?php
	...
	$query = "SELECT COUNT(*) as num FROM $table WHERE KdKel LIKE '%$cari%' OR KdJab LIKE '%$cari%' OR NmJabatan LIKE '%$cari%' order by kode";
	...
	$oList = mysql_query("SELECT * FROM $table WHERE KdKel LIKE '%$cari%' OR KdJab LIKE '%$cari%' OR NmJabatan LIKE '%$cari%' ORDER BY kode LIMIT $start, $limit");
