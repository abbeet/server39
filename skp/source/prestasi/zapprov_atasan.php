<?php	
	...
	$sql = "SELECT is_approved_akhir,tgl_approved_akhir FROM mst_skp WHERE id = '$id_skp'";
	$qu = mysql_query($sql);
...
<div id="formtable">
	<form method="post" action="source/prestasi/buat_skp_prn.php?id_skp=<?php echo $id_skp ?>&sw=<?php echo $_REQUEST['sw'] ?>" target="_blank">
		<table width="194">
			...
			<tr height="29">
				<td colspan="4"><div align="left"><strong>Persetujuan SKP oleh Atasan<br />
				</strong></div></td>
			<tr height="29">
			  <td width="13">&nbsp;</td>
			  <td colspan="3">&nbsp;</td>
			...
			<tr height="29">
				<td>&nbsp;</td>
				<td colspan="3">
				<input name="kode" type="radio"  value="0" <?php if( $row['is_approved_akhir'] == 0 ) echo 'checked' ?> />
				&nbsp;Belum<br />
				<input name="kode" type="radio"  value="1" <?php if( $row['is_approved_akhir'] == 1 ) echo 'checked' ?> />&nbsp;Setuju
				</td>
			</tr>
