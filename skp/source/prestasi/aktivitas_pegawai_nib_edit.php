...
<?php
	...
	if (isset($form)) {		
		if ($err != true) {
			...
			if ($q == "") {
				...
				<meta http-equiv="refresh" content="0;URL=index.php?p=396"><?php
				exit();
			} 
			else {
				// UPDATE
	...
	<form action="index.php?p=396" method="post" name="form">
...
if($result){
	?>
<meta http-equiv="refresh" content="0;URL=index.php?p=396">
...
<?php
	...
	<tbody><?php
		if ($count == 0) { ?>
		  ...
		  <a href="index.php?p=396&q=<?php echo $col[0][$k] ?>" title="Edit">
