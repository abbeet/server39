<?php
	...
	if (isset($form)) {		
		if ($err != true) {
			...
			if ($q == "") {
				...
				<meta http-equiv="refresh" content="0;URL=index.php?p=415&id_skp=<?php echo $id_skp ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>&sw=<?php echo $sw ?>"><?php
				exit();
			} 
			else {
				// UPDATE
	...
	<form action="index.php?p=415&id_skp=<?php echo $id_skp ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>&sw=<?php echo $sw ?>" method="post" name="form">
	<table width="755" cellspacing="1" class="admintable">
		...
		<tr>
		  ...
		  <td colspan="3"><b><a href="index.php?p=417&id_skp=<?php echo $id_skp; ?>&pagess=<?php echo $_GET['pagess']; ?>&cari=<?php echo $_GET['cari']; ?>">Kegiatan Kreativitas</a></b></td>
		</tr>
		<tr>
...
<table width="58%" cellpadding="1" class="adminlist">
	...
	<tbody><?php
		if ($count == 0) { ?>
		  ...
		  <a href="index.php?p=415&q=<?php echo $col[0][$k] ?>&id_skp=<?php echo $id_skp ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>&sw=<?php echo $sw ?>" title="Edit">
			  <img src="css/images/edit_f2.png" border="0" width="16" height="16"></a>			  	  </td>
				  <td align="center" valign="top">
		  <a href="index.php?p=417&q=<?php echo $col[0][$k] ?>&id_skp=<?php echo $id_skp ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>&sw=<?php echo $sw ?>" title="Hapus">
