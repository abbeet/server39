...
<div id="formtable">
	<form method="post" action="index.php?p=390&sw=1&id_skp=<?php echo $id_skp ?>">
		<table width="300">
			<tr height="30">
				<td>
			...
			<td colspan="3">			
					<input name="kirim" type="submit" id="k" value="  Batalkan Persetujuan  ">
					<input name="cetak" type="button" id="c" value="  Cetak  " onClick="window.open('source/prestasi/buat_skp_prn.php?id_skp=<?php echo $id_skp ?>','_blank')">
