<?php
	...
	?>
	<form action="index.php?p=271&id_skp=<?php echo $id_skp ?>&nib_penilai=<?php echo $nib_penilai ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>" method="post" name="form">
	<table width="755" cellspacing="1" class="admintable">
		...
		<tr>
		  ...
		  <td width="207"><?php echo nama_peg($nib_penilai) ?></td>
		...
		<tr>
		  <td width="224" class="key">Jabatan</td>
...
?>		
	...
	?>
				<tr class="<?php echo $class ?>">
                    ...
                    <td align="left" valign="top"><input name="jumlah_nilai[]" type="text" size="5" value="<?php echo nilai_jumlah($nib_penilai,$id_skp,$skp_dtl['no_tugas']) ?>"/><input name="no_tugas[]" type="hidden" size="5" value="<?php echo $skp_dtl['no_tugas'] ?>"/><input name="id_nilai[]" type="hidden" size="3" value="<?php echo id_penilaian($nib_penilai,$id_skp,$skp_dtl['no_tugas'])?>"/></td>
                    <td align="left" valign="top"><input name="kualitas_nilai[]" type="text" size="5" value="<?php echo nilai_kualitas($nib_penilai,$id_skp,$skp_dtl['no_tugas']) ?>"/></td>
                    <td align="left" valign="top"><input name="waktu_nilai[]" type="text" size="5" value="<?php echo nilai_waktu($nib_penilai,$id_skp,$skp_dtl['no_tugas']) ?>"/></td>
                    <td align="left" valign="top"><input name="biaya_nilai[]" type="text" size="5" value="<?php echo nilai_biaya($nib_penilai,$id_skp,$skp_dtl['no_tugas']) ?>"/></td>
			        <td align="center" valign="top"><input name="penghitungan[]" type="text" size="5" value="<?php echo number_format($perhitungan,"2",".",",") ?>"/></td>
			        <td align="center" valign="top"><input name="nilai_capaian[]" type="text" size="5" value="<?php echo number_format($perhitungan/3,"2",".",",") ?>"/></td>
				</tr>
	<?php } ?>
				<tr class="<?php echo $class ?>">
				  <td colspan="17" align="center" valign="top"><strong>NILAI CAPAIAN SKP</strong></td>
				  <td align="center" valign="top"><input name="nilai_skp" type="text" size="5" value="<?php echo number_format(($total_hitung/3)/$no,"2",".",",") ?>"/></td>
		    </tr>
	</tbody>
	<tfoot>
		<tr>
