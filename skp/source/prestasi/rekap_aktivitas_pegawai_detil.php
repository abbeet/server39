<?php
	checkauthentication();
	$table = "dtl_aktivitas";
	$field = array("id","id_skp","tgl","nib","aktivitas","hasil","id_dtl_skp","commit","approv","waktu_durasi","satuan_waktu");
	$err = false;
	$p = $_GET['p'];
	$q = $_GET['q'];
	$sw = $_GET['sw'];
	...
	<thead>
		<tr>
		  ...
		  <th colspan="2">Status</th>
           <th width="28%" rowspan="2">Durasi</th>
      </tr>
		<tr>
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
				  <td height="37" align="center" valign="top"><?php echo $k+1 ?></td>
                    ...
                    <td align="left" valign="top"><?php echo $col[9][$k].$col[10][$k] ?></td>
				</tr>
<?php } 
	  } ?>
	</tbody>
