	...
	if (isset($form)) {		
		if ($err != true) {
			...
			$id = $q;
			{
				...
				mysql_query("UPDATE mst_skp_mutasi SET tgl_kemajuan_akhir = '$tgl_kemajuan_akhir', tgl_kemajuan_akhir = '$tgl_kemajuan_akhir', status_real_akhir = '$status_real_akhir', tgl_real_akhir = '$tgl_real_akhir'
								 WHERE id = '$id_skp' ");
/*
				$value[10] = $id_skp ;
			$sql = sql_update($table,$field,$value);
				...
				<meta http-equiv="refresh" content="0;URL=index.php?p=433&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>"><?php
				exit();
			}
		}
		else {?>
	...
	<form action="index.php?p=452&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>" method="post" name="form">
