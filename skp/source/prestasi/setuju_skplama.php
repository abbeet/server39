<?php
	...
	$oList = mysql_query("SELECT * FROM $table WHERE tahun = '$th' and is_approved_awal = '1' and left(kdunitkerja,3) = '$kdbidang' and (nib LIKE '%$cari%' OR kdunitkerja LIKE '%$cari%' OR kdjabatan LIKE '%$cari%') ORDER BY kdjabatan,kdunitkerja, nib LIMIT $start, $limit");
		...
		// kasubbid
		case '5':
	$oList = mysql_query("SELECT * FROM $table WHERE tahun = '$th' and is_approved_awal = '1' and kdunitkerja = '$kdsubbidang' and (nib LIKE '%$cari%' OR kdunitkerja LIKE '%$cari%' OR kdjabatan LIKE '%$cari%') ORDER BY kdjabatan,kdunitkerja, nib LIMIT $start, $limit");
			break;
		case '6':
		...
		if ($count == 0) { ?>
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
					...
					<a href="index.php?p=451&id_skp=<?php echo $col[0][$k] ?>&sw=1" title="Approved Atasan"><img src="css/images/edit_f2.png" border="0" width="16" height="16">
			  ...
			  <a href="source/prestasi/buat_skp_prn.php?id_skp=<?php echo $col[0][$k] ?>&sw=1" title="Cetak SKP" target="_blank">
