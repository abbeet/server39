		...
		if ($count == 0) { ?>
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
				  ...
				  <a href="index.php?p=386&id_skp=<?php echo $col[0][$k] ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>" title="Edit LogBook">
			  <img src="css/images/edit_f2.png" border="0" width="16" height="16"></a>
			  	  </td>
				  <td width="5%" align="center" valign="top"><a href="source/prestasi/aktivitas_pegawai_prn.php?id_skp=<?php echo $col[0][$k] ?>" title="Cetak Aktivitas Harian" target="_blank">
