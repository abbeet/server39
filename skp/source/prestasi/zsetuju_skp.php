<?php
	...
	(nib LIKE '%$cari%' OR kdunitkerja LIKE '%$cari%' OR kdjabatan LIKE '%$cari%') ORDER BY kdunitkerja, nib LIMIT $start, $limit");
		...
		// kabid
		case '4':
	$oList = mysql_query("SELECT * FROM $table WHERE tahun = '$th' and is_approved_awal = '1' and left(kdunitkerja,3) = '$kdbidang' and (nib LIKE '%$cari%' OR kdunitkerja LIKE '%$cari%' OR kdjabatan LIKE '%$cari%') ORDER BY kdunitkerja, nib LIMIT $start, $limit");
			break;
		// kasubbid
		case '5':
		...
		if ($count == 0) { ?>
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
					...
					<td width="15%" align="center" valign="top">
					<?php if( $col[8][$k] == 0 and $xusername == $col[10][$k] ) {?>
					...
					<a href="index.php?p=267&id_skp=<?php echo $col[0][$k] ?>&sw=1" title="Batal Approved Atasan"><img src="css/images/edit_f2.png" border="0" width="16" height="16">
