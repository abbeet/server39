...
?>	
	<form action="index.php?p=398&id_skp=<?php echo $id_skp ?>&nip=<?php echo $nip ?>&tgl1=<?php echo $tgl1 ?>&tgl2=<?php echo $tgl2 ?>" method="post" name="form">
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
				  <td align="center" valign="top"><?php echo $k+1 ?></td>
					...
					{
						case '1':
						echo "<font color='#006633'>Setuju</font>";
						break;
						case '2':
						echo "<font color='#FF9933'>Tidak Setuju</font>";
						break;
						default:
						echo "<font color='#FF0000'>Draft</font>";
						break;
