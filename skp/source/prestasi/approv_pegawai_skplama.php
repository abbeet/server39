<?php	
	...
	$sql = "SELECT pesan FROM mst_skp_mutasi WHERE id = '$id_skp'";
	$qu = mysql_query($sql);
...
<div id="formtable">
	<form method="POST" action="index.php?p=449&sw=0&id_skp=<?php echo $id_skp ?>">
		<table width="194">
			<tr height="5">
				<td colspan="4"><div align="left"><strong>Pesan baru ke atasan:<br />
				</strong></div></td>
			</tr>
			<tr height="29">
				<td colspan="4">
			...
			<td colspan="3">			
					<input name="kirim" type="submit" id="k" value=" Kirim ke Atasan ">
