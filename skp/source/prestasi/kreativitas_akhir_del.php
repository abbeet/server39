<?php
	...
	if (isset($form)) {
		...
		<meta http-equiv="refresh" content="0;URL=index.php?p=441&id_skp=<?php echo $_REQUEST['id_skp'] ?>&pagess=<?php echo $_REQUEST['pagess'] ?>&cari=<?php echo $_REQUEST['cari'] ?>"><?php
		exit();
	}
	else {
...
<table width="617" cellspacing="1" class="admintable">
	...
	<tr>
		...
		<td>
			<form name="form" method="post" action="index.php?p=442&q=<?php echo $q ?>&id_skp=<?php echo $_REQUEST['id_skp'] ?>&pagess=<?php echo $_REQUEST['pagess'] ?>&cari=<?php echo $_REQUEST['cari'] ?>">				
				<div class="button2-right">
					<div class="prev">
						<a onclick="Back('index.php?p=441&id_skp=<?php echo $_REQUEST['id_skp'] ?>&pagess=<?php echo $_REQUEST['pagess'] ?>&cari=<?php echo $_REQUEST['cari'] ?>')">Batal</a>					</div>
				</div>
