		...
		if ($count == 0) { ?>
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
				  ...
				  <?php if ( ($xlevel == 0 or $xlevel == 1 or  $xlevel == 2) and $xlevel <> 10 ) {?>
		  <a href="index.php?p=263&q=<?php echo $col[0][$k] ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>" title="Edit Atasan SKP">
			  ...
			  <?php if ( $xlevel <> 10 ) {?>
			  <a href="index.php?p=446&id_skp=<?php echo $col[0][$k] ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>" title="Edit SKP">
			  <img src="css/images/edit_f2.png" border="0" width="16" height="16"><font size="1">SKP</font></a><br />
			   <?php } ?>
			  <?php } ?>			  	  </td>
				  <td width="5%" align="center" valign="top"><a href="source/prestasi/buat_skp_prn.php?id_skp=<?php echo $col[0][$k] ?>&sw=1" title="Cetak SKP" target="_blank">
			  <img src="css/images/menu/icon-16-print.png" border="0" width="16" height="16"><font size="1">SKP</font></a></td>
				  ...
				  <?php // ------- Datanya sendiri --------?>
					...
					<a href="index.php?p=448&id_skp=<?php echo $col[0][$k] ?>&sw=0" title="Approved Pegawai"><img src="css/images/edit_f2.png" border="0" width="16" height="16">
					<font color="#0033FF"><?php echo status_approv_pegawai($col[6][$k]) ?></font></a>
				  <?php } ?>
			  	  <?php if ( $col[6][$k] == '1' and  $col[8][$k] == '0' and $col[2][$k] <> $xusername ) { ?>
			  	  <?php if ( $xlevel <> 10 ) {?>
			  	  <a href="index.php?p=450&id_skp=<?php echo $col[0][$k] ?>&sw=0" title="Dikembalikan ke Pegawai">
