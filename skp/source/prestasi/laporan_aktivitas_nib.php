...
?>	
	<form action="index.php?p=336" method="post" name="form">
	<table width="497" cellspacing="1" class="admintable">
		...
		<tr>
		  ...
		  <td><strong><?php echo nama_peg($row['nip']) ?></strong></td>
	  </tr>
		<tr>
		  <td class="key">NIP</td>
		  <td><strong><?php echo reformat_nipbaru($row['nip']) ?></strong></td>
	  </tr>
		<tr>
		...
		<tr>
		  ...
		  <td><strong><?php echo nm_unitkerja(substr($row['kdunitkerja'],0,4).'00').' - RISTEK' ?></strong></td>
	  </tr>
  </table>
	<br>
...
<br /><a href="source/prestasi/laporan_aktivitas_prn.php?id_skp=<?php echo $id_skp ?>&tgl1=<?php echo $tgl1 ?>&tgl2=<?php echo $tgl2 ?>" title="Cetak Catatan Harian Pelaksanaan Tugas" target="_blank">
			  <img src="css/images/menu/icon-16-print.png" border="0" width="16" height="16"><font size="1">PDF</font></a>&nbsp;&nbsp;|
<a href="source/prestasi/laporan_aktivitas_xls.php?id_skp=<?php echo $id_skp ?>&nib=<?php echo $row['nip'] ?>&th=<?php echo $th ?>&tgl1=<?php echo $tgl1 ?>&tgl2=<?php echo $tgl2 ?>" title="Cetak Catatan Harian Pelaksanaan Tugas" target="_blank"><font size="1">Excel</font></a>
