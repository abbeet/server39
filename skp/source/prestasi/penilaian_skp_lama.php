...
<table width="66%" cellpadding="1" class="adminlist">
	<thead>
      ...
      <th colspan="2">Atasan SKP / <br />Penilai SKP</th>
			<th width="9%" rowspan="2">Nilai Capaian SKP</th>
	...
	<tbody><?php
		if ($count == 0) { ?>
			...
			foreach ($col[0] as $k=>$val) {
			 ...
			 <a href="index.php?p=457&id_skp=<?php echo $col[0][$k] ?>&nib_penilai=<?php echo $col[10][$k] ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>" title="Edit Penilaian SKP">
			  <img src="css/images/edit_f2.png" border="0" width="16" height="16"><font size="1">Penilaian SKP</font></a>
                  <?php } } ?>
                  <td width="13%" align="center" valign="top"><a href="source/prestasi/penilaian_skplama_prn.php?id_skp=<?php echo $col[0][$k] ?>&nib_penilai=<?php echo $col[10][$k] ?>&sw=1" title="Cetak Hasil Penilaian SKP" target="_blank">
