...
<div align="right">
	<form action="" method="get">
		...
		<a href="index.php?p=335&xkdunit=<?php echo $xkdunit ?>">Reset</a>
	</form>
</div><br />
		...
		if ($count == 0) { ?>
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
				    ...
				    <td align="center" valign="top"><?php if ( data_detil_ada($col[0][$k]) <> 0 ) { ?><?php echo data_detil_ada($col[0][$k]).' Catatan' ?><?php } ?></td>
		          <td width="5%" align="center" valign="top">
				  <a href="index.php?p=386&id_skp=<?php echo $col[0][$k] ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>" title="Edit Catatan Harian">
			  <img src="css/images/edit_f2.png" border="0" width="16" height="16"></a>			  	  </td>
				  <td width="5%" align="center" valign="top"><a href="index.php?p=406&id_skp=<?php echo $col[0][$k] ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>" title="Cetak Catatan Aktivitas Harian">
			  <img src="css/images/menu/icon-16-print.png" border="0" width="16" height="16"><font size="1">LogBook</font></a></td>
			      <td width="5%" align="center" valign="top"><a href="index.php?p=421&id_skp=<?php echo $col[0][$k] ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>&sw=3">
			  			<font size="1">[Rekapitulasi]</font></a></td>
				</tr>
...
<?php 
	function data_detil_ada($id_skp) {
		$result = 0 ;
		$data = mysql_query("SELECT count(id) as jml FROM dtl_aktivitas WHERE id_skp = '$id_skp' GROUP BY id_skp");
		$rdata = mysql_fetch_array($data);
		$result = trim($rdata['jml']);
		return $result;
	}
?>