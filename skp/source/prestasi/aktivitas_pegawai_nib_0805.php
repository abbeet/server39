...
<div align="right">
	<form action="index.php?p=388&kdbulan=<?php echo $kdbulan ?>" method="post">
		  ...
		  <a href="index.php?p=389&q=<?php echo $col[0][$k] ?>&id_skp=<?php echo $id_skp ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>" title="Hapus">
			  <img src="css/images/stop_f2.png" border="0" width="16" height="16"></a>
				  ...
				  <td width="6%" align="center" valign="top"><?php if ( $col[7][$k] <> '1' ) { ?>
				  	...
				  	<input name="checkbox[]" id="checkbox[]" type="checkbox" value="<?php echo $col[0][$k] ?>" /><?php echo $col[0][$k]; } ?></td>
				</tr>
<?php } 
	  } ?>
	</tbody>
