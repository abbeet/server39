	...
	if (isset($form)) {		
		if ($err != true) {
			...
			$modifiedby = $xusername_sess;
				...
				$catat    = $catatan[$i];
					if ($id <> ''){
				 		mysql_query("UPDATE dtl_penilaian_skp SET jumlah_nilai = '$jumlah', kualitas_nilai = '$kualitas', waktu_nilai = '$waktu', biaya_nilai = '$biaya', penghitungan = '$hitung', nilai_capaian = '$capaian' , catatan = '$catat' where id = '$id'");
					}else{
				 		mysql_query("INSERT INTO dtl_penilaian_skp(nib_penilai,id_skp,no_tugas,jumlah_nilai,kualitas_nilai,waktu_nilai,biaya_nilai,catatan)
	...
	?>
				...
				<tr class="<?php echo $class ?>">
				  ...
				  <td align="left" valign="top"><?php echo $skp_dtl['nama_tugas'] ?>
                    ...
                    <td align="left" valign="top"><input name="jumlah_nilai[]" type="text" id="jumlah_nilai" size="5" value="<?php echo nilai_jumlah($nib_penilai,$id_skp,$skp_dtl['no_tugas']) ?>" onfocus="startCalculate(<?php echo $no-1;?>)" onblur="stopCalc()" <?php if ($row['status_real_awal'] == 0) echo "disabled=\"disabled\""; ?> /><?php echo $skp_dtl['satuan_jumlah'] ?>
...
?>			
				<tr class="<?php echo $class ?>">
				  ...
				  <td align="left" valign="top"><?php echo $List['nama_tugas'] ?>
	...
	<tfoot>
		<tr>
			...
			<input name="status_real_awal" type="radio" value="0" <?php if( $row['status_real_awal'] == 0 ) echo 'checked="checked"' ?>/>&nbsp;&nbsp;Draf&nbsp;&nbsp;
	  		...
	  		<input name="status_real_awal" type="radio" value="2" <?php if( $row['status_real_awal'] == 2 ) echo 'checked="checked"' ?> />&nbsp;&nbsp;Dinilai Atasan&nbsp;&nbsp;
			</td>
		    </tr>
	</tfoot>
</table>		  </td>
