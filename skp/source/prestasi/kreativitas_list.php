...
<div class="button2-right">
					<div class="prev">
						<a onClick="Cancel('index.php?p=415&id_skp=<?php echo $id_skp ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>')">Kembali</a>
					</div>
</div><br /><br />
...
<table width="65%" cellpadding="1" class="adminlist">
	...
	<?php 
	$oList = mysql_query("SELECT * FROM dtl_aktivitas WHERE id_skp = '$id_skp' and id_dtl_skp = -2 ORDER BY tgl");
