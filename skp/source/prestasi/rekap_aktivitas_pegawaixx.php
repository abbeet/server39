		...
		if ($count == 0) { ?>
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
				    ...
				    <td align="center" valign="top"><?php if ( $jumlah <> 0 ) { ?><a href="index.php?p=410&nib=<?php echo $row['nib'] ?>&id_skp=<?php echo $row['id'] ?>&id_dtl_skp=<?php echo $col[0][$k] ?>" title="Lihat Aktivitas Harian">Lihat Detil</a><?php } ?></td>
