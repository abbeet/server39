<?php
	...
	$cari = $_GET['cari'];
	$table = "mst_skp";
	$field = array("id","tahun","nip","kdunitkerja","kdjabatan","kdgol","is_approved_awal","tgl_approved_awal", "is_approved_akhir", "tgl_approved_akhir","nib_atasan", "jabatan_atasan", "kdgol_atasan","grade","status_real_awal","tgl_real_awal","tgl_kemajuan_awal","tgl_kemajuan_akhir");
...
<table width="70%" cellpadding="1" class="adminlist">
	<thead>
      ...
      <th colspan="3">Atasan</th>
			<th width="7%" rowspan="2">Periode<br />
		    Penilaian SKP</th>
		...
		if ($count == 0) { ?>
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
                    ...
                    <td align="center" valign="top"><?php echo reformat_tgl($col[9][$k]) ?></td>
                    <td align="center" valign="top"><?php echo reformat_tgl($col[16][$k]).'<br>s/d<br>'.reformat_tgl($col[17][$k]) ?></td>                    
                  <td width="7%" align="center" valign="top">
				  <?php switch ( $col[14][$k] )
				  		 { 
						      case '0' :?>
			  				<a href="index.php?p=411&id_skp=<?php echo $col[0][$k] ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>" title="Edit Laporan Kemajuan SKP">
			  				<img src="css/images/edit_f2.png" border="0" width="16" height="16"><font size="1">Kemajuan SKP</font></a>
			  		<?php     break;
				  ...
				  <?php if ( $col[14][$k] == '0' ) { ?>
				  <a href="index.php?p=412&id_skp=<?php echo $col[0][$k] ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>" title="Input Tugas Tambahan">
			  	  <img src="css/images/edit_f2.png" border="0" width="16" height="16"><font size="1">Tugas Tambahan</font></a>
			  	  <?php } ?>
			  </td>
				  <td width="4%" align="center" valign="top">
				  <?php if ( $col[14][$k] == '0' ) { ?>
				  <a href="index.php?p=415&id_skp=<?php echo $col[0][$k] ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>" title="Input Kegiatan Kreativitas">
			     <img src="css/images/edit_f2.png" border="0" width="16" height="16"><font size="1">Kreatifitas</font></a>
			  	  <?php } ?>
				 </td>
				  <td width="4%" align="center" valign="top">
				  <?php if ( $col[14][$k] == '0' or $col[14][$k] == '1' ) { ?>
			  <a href="source/prestasi/realisasi_skp_awal_prn.php?id_skp=<?php echo $col[0][$k] ?>" title="Cetak Capaian SKP Awal (Tengah Tahun)" target="_blank">
			  <img src="css/images/menu/icon-16-print.png" border="0" width="16" height="16"><font size="1">Cetak Kemajuan SKP</font></a>
			  	<?php }else{ ?>
			  <a href="source/prestasi/penilaian_skp_prn.php?id_skp=<?php echo $col[0][$k] ?>&nib_penilai=<?php echo $col[10][$k] ?>" title="Cetak Hasil Penilaian SKP" target="_blank">
			  <img src="css/images/menu/icon-16-print.png" border="0" width="16" height="16"><font size="1">Cetak Hasil Penilaian</font></a>
			  	<?php } ?>
			  </td>
				</tr>
