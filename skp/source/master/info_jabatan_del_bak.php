...
<table width="617" cellspacing="1" class="admintable">
	...
	<tr>
		...
		<td><input type="text" size="80" readonly="readonly" value="<?php echo $value[3] ?>" /></td>
	</tr>
	<tr>
	  <td class="key">Jumlah</td>
	  <td><input type="text" size="5" readonly="readonly" value="<?php echo $value[5] ?>" /></td>
  </tr>
	<tr>
	  <td class="key">Ihtisar Jabatan</td>
	  <td><textarea rows="3" cols="60" readonly="readonly"><?php echo $value[4] ?></textarea></td>
  </tr>
