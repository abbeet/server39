...
<form action="index.php?p=<?php echo $_GET['p'] ?>" method="post" name="form">
	<table class="admintable" cellspacing="1">
		<tr>
			...
			<td>
				<input type="radio" name="<?php echo $field[1] ?>" value="js" <?php if ($value[1] == 'js') echo "checked=\"checked\"" ?>/>Javascript&nbsp;
				<input type="radio" name="<?php echo $field[1] ?>" value="css" <?php if ($value[1] == 'css') echo "checked=\"checked\"" ?>/>CSS
			</td>
		</tr>
		<tr>
