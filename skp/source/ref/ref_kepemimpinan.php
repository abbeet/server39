<?php
	...
	$query = "SELECT COUNT(*) as num FROM $table WHERE unsur_kp LIKE '%$cari%' OR bobot_kp LIKE '%$cari%' ";
	...
	$oList = mysql_query("SELECT * FROM $table WHERE unsur_kp LIKE '%$cari%' OR bobot_kp LIKE '%$cari%' ORDER BY id_kp LIMIT $start, $limit");
...
<table width="274" cellpadding="1" class="adminlist">
	<thead>
		<tr>
			<th width="13%">No.</th>
			<th width="51%">Unsur Kepemimpinan</th>
