<?php
	...
	$query = "SELECT COUNT(*) as num FROM $table WHERE unsur_km LIKE '%$cari%' OR bobot_km LIKE '%$cari%' ";
	...
	$oList = mysql_query("SELECT * FROM $table WHERE unsur_km LIKE '%$cari%' OR bobot_km LIKE '%$cari%' ORDER BY id_km LIMIT $start, $limit");
