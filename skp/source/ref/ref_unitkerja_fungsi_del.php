...
<table width="488" cellspacing="1" class="admintable">
	...
	<tr>
		<td>&nbsp;</td>
		<td>
			<form name="form" method="post" action="index.php?p=<?php echo $_GET['p'] ?>&u=<?php echo $u; ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>">				
				<div class="button2-right">
					<div class="prev">
						<a onclick="Back('index.php?p=239&u=<?php echo $u ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>')">Batal</a>
					</div>
				</div>
