<?php
	...
	$query = "SELECT COUNT(*) as num FROM $table order by kdgol";
	...
	$oList = mysql_query("SELECT * FROM $table ORDER BY kdgol LIMIT $start, $limit");
		...
		if ($count == 0) { ?>
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
					...
					<td align="left" valign="top"><?php echo 'Golongan '.nmromawi($col[1][$k]) ?></td>
