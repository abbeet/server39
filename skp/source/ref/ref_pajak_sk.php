<?php
	...
	$query = "SELECT COUNT(*) as num FROM $table order by KdKawin";
	...
	$oList = mysql_query("SELECT * FROM $table ORDER BY KdKawin LIMIT $start, $limit");
		...
		if ($count == 0) { ?>
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
					...
					<td align="left" valign="top"><?php echo $col[0][$k] ?></td>
					<td align="left" valign="top"><?php echo $col[1][$k] ?></td>
					<td align="right" valign="top"><?php echo number_format($col[2][$k]) ?></td>
	            </tr><?php
			}
		} ?>
	</tbody>
