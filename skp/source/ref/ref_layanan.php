<?php
	...
	$query = "SELECT COUNT(*) as num FROM $table WHERE unsur_ol LIKE '%$cari%' OR bobot_ol LIKE '%$cari%' ";
	...
	$oList = mysql_query("SELECT * FROM $table WHERE unsur_ol LIKE '%$cari%' OR bobot_ol LIKE '%$cari%' ORDER BY id_ol LIMIT $start, $limit");
		...
		if ($count == 0) { ?>
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
				  ...
				  <td align="center" valign="top">Jumlah Bobot</td>
				  <td align="center" valign="top"><?php echo $jml_bobot ?></td>
				  <td align="center" valign="top">&nbsp;</td>
				  <td align="center" valign="top">&nbsp;</td>
	  </tr>
	</tbody>
