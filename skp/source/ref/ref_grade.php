<?php
	...
	$query = "SELECT COUNT(*) as num FROM $table order by kd_grade desc";
	...
	$oList = mysql_query("SELECT * FROM $table ORDER BY kd_grade desc LIMIT $start, $limit");
	...
	echo $pagination;
?>
<table width="24%" cellpadding="1" class="adminlist">
	<thead>
		<tr>
		...
		<tr>
		  <th width="12%">Jakarta</th>
	      <th width="14%">Bandung</th>
	      <th width="13%">Yogya</th>
	  </tr>
	</thead>
	<tbody><?php
		if ($count == 0) { ?>
