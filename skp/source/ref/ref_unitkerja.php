<?php
	...
	$query = "SELECT COUNT(*) as num FROM $table WHERE kdunit < '2324000' and (nmunit LIKE '%$cari%' OR kdunit LIKE '%$cari%') ";
	...
	$oList = mysql_query("SELECT * FROM $table WHERE kdunit < '2324000' and (nmunit LIKE '%$cari%' OR kdunit LIKE '%$cari%') ORDER BY kdunit LIMIT $start, $limit");
