<?php
	...
	$query = "SELECT COUNT(*) as num FROM $table order by kdpot ";
	$total_pages = mysql_fetch_array(mysql_query($query));
	$total_pages = $total_pages[num];
	
	#variabel query
	$targetpage = "index.php?p=$p&cari=$cari"; 	#nama file  (nama file ini)
	$limit = 12; 							#berapa yang akan ditampilkan setiap halaman
	$pagess = $_GET['pagess'];
	if($pagess) 
	...
	$oList = mysql_query("SELECT * FROM $table ORDER BY kdpot LIMIT $start, $limit");
