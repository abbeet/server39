...
<form action="index.php?p=<?php echo $_GET['p'] ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>" method="post" name="form">
	<table width="643" cellspacing="1" class="admintable">
		...
		<tr>
		  ...
		  <td width="461" colspan="3"><input type="text" name="<?php echo $field[0] ?>" size="10" value="<?php echo $value[0] ?>" />&nbsp;&nbsp;</td>
	  </tr>
		<tr>
		  <td class="key">Keterangan</td>
		  <td colspan="3"><input type="text" name="<?php echo $field[1] ?>" size="70" value="<?php echo $value[1] ?>" /></td>
	  </tr>
		<tr>
