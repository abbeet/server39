...
<form action="index.php?p=<?php echo $_GET['p'] ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>" method="post" name="form">
	<table width="643" cellspacing="1" class="admintable">
		...
		<tr>
		  ...
		  <td width="461" colspan="3"><input type="text" name="<?php echo $field[1] ?>" size="5" value="<?php echo $value[1] ?>" /></td>
	  </tr>
		<tr>
		  <td class="key">Jenis Potongan </td>
		  <td colspan="3"><input type="text" name="<?php echo $field[2] ?>" size="50" value="<?php echo $value[2] ?>" /></td>
	  </tr>
		<tr>
		  <td class="key">Nilai Potongan </td>
