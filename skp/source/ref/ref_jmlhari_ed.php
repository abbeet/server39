...
<form action="index.php?p=<?php echo $_GET['p'] ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>" method="post" name="form">
	<table width="643" cellspacing="1" class="admintable">
		...
		<tr>
		  <td width="173" class="key">Bulan</td>
		  <td width="461" colspan="3"><input type="text" name="<?php echo $field[2] ?>" size="5" value="<?php echo $value[2] ?>" />&nbsp;&nbsp;Tahun&nbsp;<input type="text" name="<?php echo $field[1] ?>" size="5" value="<?php echo $value[1] ?>" /></td>
	  </tr>
		<tr>
		  <td class="key">Jumlah Hari Efektif </td>
		  <td colspan="3"><input type="text" name="<?php echo $field[3] ?>" size="5" value="<?php echo $value[3] ?>" /></td>
	  </tr>
