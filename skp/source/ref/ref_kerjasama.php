<?php
	...
	$query = "SELECT COUNT(*) as num FROM $table WHERE unsur_ks LIKE '%$cari%' OR bobot_ks LIKE '%$cari%' ";
	...
	$oList = mysql_query("SELECT * FROM $table WHERE unsur_ks LIKE '%$cari%' OR bobot_ks LIKE '%$cari%' ORDER BY id_ks LIMIT $start, $limit");
...
<table width="274" cellpadding="1" class="adminlist">
	<thead>
		<tr>
			<th width="13%">No.</th>
			<th width="51%">Unsur Kerjasama </th>
