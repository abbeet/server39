...
<table width="617" cellspacing="1" class="admintable">
	...
	<tr>
	  ...
	  <td><textarea cols="70" rows="3" readonly="readonly"><?php echo $value[3] ?></textarea></td>
  </tr>
		...
		<td>
			<form name="form" method="post" action="index.php?p=<?php echo $_GET['p'] ?>&kdjab=<?php echo $kdjab ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>">				
				<div class="button2-right">
					<div class="prev">
						<a onclick="Back('index.php?p=379&kdjab=<?php echo $kdjab ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>')">Batal</a>					</div>
				</div>
