<?php
	...
	$query = "SELECT COUNT(*) as num FROM $table WHERE kdkel LIKE '%$cari%' OR sktkel LIKE '%$cari%' OR nmkel LIKE '%$cari%' ";
	...
	$oList = mysql_query("SELECT * FROM $table WHERE kdkel LIKE '%$cari%' OR sktkel LIKE '%$cari%' OR nmkel LIKE '%$cari%' ORDER BY kdkel LIMIT $start, $limit");
...
<div align="right">
	<form action="" method="get">
		...
		<a href="index.php?p=237">Reset</a>
	</form>
</div><br />
<table cellpadding="1" class="adminlist">
	<thead>
		<tr>
			<th width="4%">No.</th>
			<th width="6%">Kode</th>
			<th width="25%">Kelompok  Jabatan</th>
