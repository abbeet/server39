...
<table width="617" cellspacing="1" class="admintable">
	...
	<tr>
	  ...
	  <td><input type="text" size="60" readonly="readonly" value="<?php echo nm_kelompok_bantu($kdjab,$value[2]) ?>" /></td>
  </tr>
	<tr>
		...
		<td>
			<form name="form" method="post" action="index.php?p=<?php echo $_GET['p'] ?>&kdjab=<?php echo $kdjab ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>">				
				<div class="button2-right">
					<div class="prev">
						<a onclick="Back('index.php?p=376&kdjab=<?php echo $kdjab ?>&pagess=<?php echo $pagess ?>&cari=<?php echo $cari ?>')">Batal</a>					</div>
				</div>
