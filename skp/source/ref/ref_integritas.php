<?php
	...
	$query = "SELECT COUNT(*) as num FROM $table WHERE unsur_it LIKE '%$cari%' OR bobot_it LIKE '%$cari%' ";
	...
	$oList = mysql_query("SELECT * FROM $table WHERE unsur_it LIKE '%$cari%' OR bobot_it LIKE '%$cari%' ORDER BY id_it LIMIT $start, $limit");
...
<table width="274" cellpadding="1" class="adminlist">
	<thead>
		<tr>
			<th width="13%">No.</th>
			<th width="51%">Unsur Integritas</th>
