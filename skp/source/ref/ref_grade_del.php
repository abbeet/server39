...
<table width="617" cellspacing="1" class="admintable">
	...
	<tr>
		...
		<td><input type="text" size="30" readonly="readonly" value="<?php echo $value[2] ?>" /></td>
	</tr>
	<tr>
	  <td class="key">Jakarta (53%)</td>
	  <td><input type="text" size="30" readonly="readonly" value="<?php echo $value[3] ?>" /></td>
  </tr>
	<tr>
	  <td class="key">Bandung (53%)</td>
	  <td><input type="text" size="30" readonly="readonly" value="<?php echo $value[4] ?>" /></td>
  </tr>
	<tr>
	  <td class="key">Yogya (53%)</td>
	  <td><input type="text" size="30" readonly="readonly" value="<?php echo $value[5] ?>" /></td>
  </tr>
