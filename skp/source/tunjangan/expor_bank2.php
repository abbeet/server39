...
switch ($xlevel)
	{
		...
		$kdbulan2 = $_REQUEST['kdbulan2'];
		if ( strlen($kdbulan2) == 1 )    $kdbulan2 = '0'.$kdbulan2 ;
	$oList = mysql_query("SELECT count(nib) as jumlah, nib,nip,norec,sum(nil_terima) as jml_terima FROM $table WHERE tahun = '$th' and kdsatker = '$kdsatker' and bulan >= '$kdbulan1' and bulan <= '$kdbulan2' GROUP BY nib ORDER BY nib, grade desc LIMIT $start, $limit");
...
<a href="source/tunjangan/expor_bank2_xls.php?kdsatker=<?php echo $kdsatker ?>&kdbulan1=<?php echo $kdbulan1 ?>&kdbulan2=<?php echo $kdbulan2 ?>&th=<?php echo $th ?>" title="Cetak Slip"><img src="css/images/menu/icon-16-print.png" border="0" width="16" height="16"><font size="1">Excel</font></a>
<table width="106%" cellpadding="1" class="adminlist">
	<thead>
