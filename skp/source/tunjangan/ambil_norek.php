	...
	{		
		if ($err != true) 
		{
			...
			if ($_FILES['gpp']['name'] != "")
			{
				...
				if(empty($row)){
					$sql = "INSERT INTO dt_filegpp (kdfile,nama_file,tgl_upload,user_upload,type,kdsatker,keterangan) values ('NOREC','$filename','$tgl_upload','$xusername','gpp','$kdsatker','File Pegawai')";				
...
-->
  ...
  <table cellspacing="1" class="admintable">
    <tr> 
      <td width="99" class="key">Tahun Anggaran</td>
      <td width="657"><?php echo date('Y') ?></td>
    </tr>
    <tr>
