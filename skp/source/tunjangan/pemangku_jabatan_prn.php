...
/*	$pdf->Ln();
	...
	$pdf->SetX($margin+$w[0]);
	$pdf->Cell($w[1],$ln,'DAFTAR PEMEGANG JABATAN','',1,'C');
	$pdf->SetX($margin+$w[0]);
	...
	$pdf->Cell($w1[1],$ln,'Bidang/Bagian',$noborder,0,'C');
	$y = $pdf->GetY();
	$pdf->SetXY($margin+$w1[0],$y+4);
	$pdf->Cell($w1[1],$ln,'SubBidang/SubBagian',$noborder,0,'C');
	$pdf->SetXY($margin+$w1[0],$y);
	$pdf->Cell($w1[1],$ln*2,'',$border,0,'C');
	$pdf->SetX($margin+$w1[0]+$w1[1]);
	$pdf->Cell($w1[2],$ln*2,'Nama Pegawai',$border,0,'C');
	$pdf->SetX($margin+$w1[0]+$w1[1]+$w1[2]);
	$pdf->Cell($w1[3],$ln*2,'Gol.',$border,0,'C');
	$pdf->SetX($margin+$w1[0]+$w1[1]+$w1[2]+$w1[3]);
	$pdf->Cell($w1[4],$ln*2,'Nama Jabatan',$border,0,'C');
	$pdf->SetX($margin+$w1[0]+$w1[1]+$w1[2]+$w1[3]+$w1[4]);
	$pdf->Cell($w1[5],$ln*2,'Grade',$border,1,'C');
...
*/
	...
	$arrGrade	  = $pdf->SplitToArray($w1[5],$ln,$row['grade']);
