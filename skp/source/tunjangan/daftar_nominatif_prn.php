...
/*
	...
	for($i=0;$i<$max;$i++)
	{
		...
		$max = 0 ;
	$arrJabatan_1	 = $pdf->SplitToArray($w1[1],$ln,'Telah diverifikasi');
	$arrJabatan_2	 = $pdf->SplitToArray($w1[3],$ln,'');
	$arrJabatan_3	 = $pdf->SplitToArray($w1[5],$ln,'Telah diverifikasi');
	...
	$max = 0 ;
	$arrJabatan_1	 = $pdf->SplitToArray($w1[1],$ln,'Nama dan Kelas Jabatan');
	$arrJabatan_2	 = $pdf->SplitToArray($w1[3],$ln,'');
	$arrJabatan_3	 = $pdf->SplitToArray($w1[5],$ln,'Tunjangan Kinerja');
	...
	$max = 0 ;
	$arrJabatan_1	 = $pdf->SplitToArray($w1[1],$ln,'oleh Subbag Kepegawaian pada');
	$arrJabatan_2	 = $pdf->SplitToArray($w1[3],$ln,'');
	$arrJabatan_3	 = $pdf->SplitToArray($w1[5],$ln,'oleh Subbag Keuangan pada');
