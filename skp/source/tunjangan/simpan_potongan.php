<?php
	...
	{		
		...
		$sql_tk = "UPDATE mst_tk SET kurang = '$totpot'  WHERE nib = '$nib' and tahun = '$tahun' AND bulan = '$bulan' and grade = '$grade' ";
		//mysql_query($sql_tk);
			?>
...
<form action="index.php?p=<?php echo $_GET['p'] ?>" method="post" name="form">
  ...
  <table width="721" cellspacing="1" class="admintable">
    <tr>
      <td colspan="2"><span class="style1"><?php echo $kdpeg . " " . $tunker?>Simpan Potongan Tunjangan Kinerja </span></td>
    </tr>
    <tr>
      <td colspan="2">&nbsp;</td>
    </tr>
