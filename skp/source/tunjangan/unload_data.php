<?php
	...
	{		
		if ($err != true) 
		{
			...
			$sql = "SELECT nib FROM mst_tk WHERE tahun = '$tahun' AND bulan = '$bulan' AND kdsatker = '$xusername'"; 
			$qu = mysql_query($sql);
										
			while ($row = mysql_fetch_array($qu))
			{
					$nib = $row['nib'];
					$sql_inp = "UPDATE mst_tk SET status = '0' , tgl_status = ' ' WHERE nib = '$nib' ";
					mysql_query($sql_inp);
				#}
...
-->
  ...
  <table width="721" cellspacing="1" class="admintable">
    <tr>
      <td colspan="2"><span class="style1">Batalkan Status Simpan </span></td>
    </tr>
    <tr>
      <td colspan="2">&nbsp;</td>
    </tr>
