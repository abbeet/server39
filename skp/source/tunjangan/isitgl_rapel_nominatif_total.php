<?php	
	...
	$th = $_REQUEST['th'];
?>
	<form method="post" action="source/tunjangan/rapel_nominatif_total_prn.php?kdsatker=<?php echo $kdsatker ?>&kdbulan1=<?php echo $kdbulan1 ?>&kdbulan2=<?php echo $kdbulan2 ?>&th=<?php echo $th ?>" target="_blank">
