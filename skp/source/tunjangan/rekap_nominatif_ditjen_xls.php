<?php
	...
	$oList = mysql_query("SELECT grade, count(nip) as jumlah, sum(tunker) as jml_tunker, sum(pajak_tunker) as jml_pajak FROM mst_tk
	WHERE tahun = '$th' and bulan = '$kdbulan' GROUP BY grade ORDER BY grade desc");
	...
	$filename = "rekap_nominatif_" . $kdbulan . ".xls";
