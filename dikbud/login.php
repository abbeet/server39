		...
		<div class="rapidxwpr floatholder">
			...
			<div id="news">
				...
				<!-- logo -->
					...
					<img src="images/news.png" alt="Home" title="Home" />
				<!-- / logo -->
						...
						<div id="right" class="clearingfix">
						  ...
						  <div class="benefits">
							<div class="benefits-bg clearingfix">
									<h4>&nbsp;</h4>
									<h4><font size="+1" style="font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif; color:#55555"><b>Login</b></font></h4>
									<?php
									...
									<form name="xlogin" method="post" action="">
										<table>
											<tr>
												<td style="font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif; color:#555555">Username&nbsp;</td>
												<td>&nbsp;<input type="text" name="xusername" /></td>
											</tr>
											<tr>
												<td style="font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif; color:#555555">Password&nbsp;</td>
...
<div id="container">
	<div id="judul">
	  ...
	  <span><font size="3" color="#555555" style="font-family:'Lucida Sans Unicode', 'Lucida Grande', sans-serif"><b>di Sistem Informasi Perencanaan, Monitoring dan Evaluasi Kinerja
</font><br />
	  </span></h1>
	...
	<div id="isi">
		<div id="slider">
			<ul>				
				...
				<li><a href="manual_amerta.pdf"><img src="slider/04.png"  /></a></li>	
			</ul>
		</div>
	</div>
</div>
