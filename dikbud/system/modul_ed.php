...
<form action="index.php?p=<?php echo $_GET['p'] ?>" method="post" name="form">
	<table class="admintable" cellspacing="1">
		...
		<tr>
			...
			<td>
				<input type="radio" name="<?php echo $field[2] ?>" value="1" <?php if ($value[2] == 1) echo "checked=\"checked\"" ?>/>Ya&nbsp;
				<input type="radio" name="<?php echo $field[2] ?>" value="0" <?php if ($value[2] == 0) echo "checked=\"checked\"" ?>/>Tidak
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
