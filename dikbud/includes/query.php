<?php	
	...
	function get_field($table) {
		switch ($table) {
			...
			case "xuser": $field = array("id","username","password","level","lastvisit","lastmodified","modifiedby","kdunit"); break;
			...
			case "tb_provinsi": $field = array("id","kdprov","nmprov"); break;
			case "tb_kabupaten": $field = array("id","kdprov","kdkab","nmkab"); break;
			case "ref_bidang": $field = array("id","kdbidang","nmbidang"); break;
			case "ref_subbidang": $field = array("id","kdbidang","kdsubbidang","nmsubbidang"); break;
			case "ref_jenis": $field = array("id","kdbidang","kdsubbidang","kdjenis","nmjenis"); break;
			case "dt_kegiatan": $field = array("id","kdkegiatan","tahun","lokasi","kdprov","kdkab","kdbidang","kdsubbidang","kdjenis","produk_batan","vol_rencana","sat_rencana",
										"vol_realisasi","sat_realisasi","vol_hasil","sat_hasil","anggaran","realisasi","pelaksana","monev_1","monev_2"); break;
			case "dt_monev": $field = array("id","kdkegiatan","waktu_monev","kdjns_monev","hasil_monev"); break;
		}
