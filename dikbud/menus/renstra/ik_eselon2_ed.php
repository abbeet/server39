	...
	{		
		...
		{	
			if ($q == "") 
			{
				...
				<meta http-equiv="refresh" content="0;URL=index.php?p=583&no_sasaran=<?php echo $no_sasaran ?>&kdunit=<?php echo $kdunit ?>"><?php
				exit();
			} 
			else {
				// UPDATE
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
					...
					<td width="7%" align="center">
						<a href="index.php?p=583&no_sasaran=<?php echo $no_sasaran; ?>&q=<?php echo $col[0][$k]; ?>&kdunit=<?php echo $kdunit ?>" title="Edit">
