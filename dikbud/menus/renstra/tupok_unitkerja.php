<?php
	...
	$query = "SELECT COUNT(*) as num FROM $table WHERE nmunit LIKE '%$cari%' OR kdunit LIKE '%$cari%' OR tugas LIKE '%$cari%' ";
...
<div align="right">
	<form action="" method="get">
		...
		<a href="index.php?p=364">Reset</a>
	</form>
</div><br />
<table width="393" cellpadding="1" class="adminlist">
	<thead>
		<tr>
			<th width="15%">No.</th>
			<th width="12%">Kode</th>
