<?php
	...
	$oList = mysql_query("SELECT * FROM $table WHERE nmunit LIKE '%$cari%' OR kdunit LIKE '%$cari%' OR visi LIKE '%$cari%' ORDER BY kdunit LIMIT $start, $limit");
...
<div align="right">
	<form action="" method="get">
		...
		<a href="index.php?p=357">Reset</a>
	</form>
</div><br />
				...
				<tr class="<?php echo $class ?>">
				  ...
				  <td colspan="2" align="left" valign="top"><?php echo $col[3][$k] ?></td>
					<td colspan="2" align="center" valign="top">
						<a href="index.php?p=391&kdunit=<?php echo $col[1][$k] ?>" title="Tambah Misi">
...
?>				
				<tr class="<?php echo $class ?>">
				  ...
				  <td align="center" valign="top"><a href="index.php?p=391&q=<?php echo $Misi['id'] ?>" title="Edit Misi">
				  <img src="css/images/edit_f2.png" border="0" width="16" height="16"></a></td>
	              <td align="center" valign="top"><a href="index.php?p=362&q=<?php echo $Misi['id'] ?>" title="Delete Misi">
