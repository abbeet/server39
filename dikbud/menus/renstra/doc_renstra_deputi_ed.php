	...
	{		
		if ($err != true) 
		{
			...
			if ($_FILES['nmfile']['name'] != "")
			{
				...
				$filedir = "file_renstra/".$xkdunit."/".$th.'_'.$filename ;
			...
			<meta http-equiv="refresh" content="0;URL=index.php?p=447&xkdunit=<?php echo $xkdunit ?>"><?php
			exit();
...
<script type="text/javascript">
	function form_proses()
		{
            ...
            <form action="index.php?p=447&xkdunit=<?php echo $xkdunit ?>" method="post" name="xproses" enctype="multipart/form-data">
  ...
  <table cellspacing="1" class="admintable">
    ...
    <tr>
      ...
      <td><strong><?php echo ket_unit($xkdunit) ?></strong></td>
    </tr>
...
<?php
	$sql = "select * from dt_fileupload WHERE th = '$th' and kdunitkerja = '$xkdunit' and keterangan = 'Renstra' order by nourut";
