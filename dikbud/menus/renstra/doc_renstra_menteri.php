...
<table width="927" cellpadding="1">
  <thead>
    <tr>
      <th colspan="3" align="left"><font size="4" color="#009900">RENSTRA<br /><?php echo nm_unit('480000').'<br>'.th_renstra($th) ?></font></th> 
      </tr>
  </thead>
  <tbody>
    ...
    <tr >
      <td width="24%" align="center" valign="top" class="row7"><img src="<?php echo 'file_renstra/480000/'.cover_renstra($th,'480000') ?>" border="1" width="220" height="300"><br />
        <br />
...
<div class="next"><a onclick="Back('index.php?p=445')">Update</a></div>
    ...
    { ?>
	  <a href= "index.php?p=446&kdunit=<?php  echo "480000" ?>&nourut=<?php echo "$List[nourut]" ?>&nama=<?php echo "$List[nama_file]" ?>" ><font size="2"><?php echo '=> '.$List['dafisi'] ?></font></a><br>
<?php	}  
	  ?></font>	  </td>
