...
<table width="884" cellpadding="1">
  <thead>
    <tr>
      <th colspan="3" align="left"><font size="4" color="#009900">RENSTRA<br />
          <?php echo nm_unit($xkdunit).'<br>'.th_renstra($th) ?></font></th> 
    </tr>
  </thead>
  <tbody>
...
<div class="next"><a onclick="Back('index.php?p=447&xkdunit=<?php echo $xkdunit ?>')">Update</a></div>
</div>	  </td> 
    ...
    { ?>
	  <a href= "index.php?p=448&kdunit=<?php  echo "$List[kdunitkerja]" ?>&nourut=<?php echo "$List[nourut]" ?>&nama=<?php echo "$List[nama_file]" ?>" ><font size="2"><?php echo '=> '.$List['dafisi'] ?></font></a><br>
	<?php
	}  
	  ?></font>	  </td>
