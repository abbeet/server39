<?php
	...
	{		
		...
		{	
			...
			{
				//ADD NEW				
				$sql = "INSERT INTO $table VALUE ('','$th', '2320000' , '$no_iku','$nm_iku','$no_sasaran' , '$target_1' , '$target_2' , '$target_3' , '$target_4' , '$target_5')";
				$rs = mysql_query($sql);
				...
				<meta http-equiv="refresh" content="0;URL=index.php?p=521&no_sasaran=<?php echo $no_sasaran ?>"><?php
				exit();
			} 
			else {
				// UPDATE
				$sql = "UPDATE $table SET no_iku = '$no_iku', nm_iku = '$nm_iku', target_1 = '$target_1' ,
...
<form action="index.php?p=<?php echo $_GET['p']; ?>&no_sasaran=<?php echo $no_sasaran ?>&q=<?php echo $q ?>" method="post" name="form">
	<table width="803" cellspacing="1" class="admintable">
		
		<tr>
			<td width="173" class="key">Kementerian</td>
			<td width="621">
			<input type="text" size="70" value="<?php echo nm_unit($kdmenteri) ?>" disabled="disabled"/>			</td>
		</tr>
		<tr>
...
<?php
	$sql = "SELECT * FROM $table WHERE ta = '$th' and no_sasaran = '$no_sasaran' and kdunit = '2320000' ORDER BY no_iku";
...
<table width="274" cellpadding="1" class="adminlist">
	<thead>
		<tr>
			...
			<th width="70%" rowspan="2">Indikator Kinerja Utama<br />(IKU)</th>
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
					...
					<td width="7%" align="center">
						<a href="index.php?p=521&no_sasaran=<?php echo $no_sasaran; ?>&q=<?php echo $col[0][$k]; ?>" title="Edit">
							<img src="css/images/edit_f2.png" border="0" width="16" height="16">						</a>					</td>
					<td width="7%" align="center">
						<a href="index.php?p=522&no_sasaran=<?php echo $no_sasaran ?>&q=<?php echo $col[0][$k]; ?>" title="Delete">
