...
switch ( $xlevel )
{
	...
	default :
	$query = "SELECT COUNT(*) as num FROM $table WHERE kdunit > '2320600'";
	break ;
}	
...
switch ( $xlevel )
{
	...
	default :
	$query = "SELECT * FROM $table WHERE ta = '$th' and kdunit > '2320600' order by kdunit,no_sasaran";
	break ;
}	
...
<table width="843" cellpadding="1" class="adminlist">
	<thead>
		<tr>
		  <th width="23%" height="45" rowspan="3">Satker Mandiri</th>
			<th colspan="8"><font color="#0000FF">Sasaran</font></th>
		  <th colspan="2" rowspan="3"><a href="index.php?p=514" title="Input Sasaran Eselon II">
	...
	<tbody><?php
		...
		<?php
			...
			<tr class="<?php echo $class ?>">
	          ...
	          <td colspan="2" align="center"><a href="index.php?p=605&no_sasaran=<?php echo $col[1][$k] ?>&kdunit=<?php echo $col[3][$k] ?>" title="Tambah Indikator Kinerja">
...
?>	  
		<tr>
		    ...
		    <td width="5%" align="center"><a href="index.php?p=605&q=<?php echo $List['id'] ?>&kdunit=<?php echo $col[3][$k] ?>" title="Edit Sasaran">
				  <img src="css/images/edit_f2.png" border="0" width="16" height="16"></a></td>
		    <td width="7%" align="center"><a href="index.php?p=606&q=<?php echo $List['id'] ?>&kdunit=<?php echo $col[3][$k] ?>" title="Delete Sasaran">
