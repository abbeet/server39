...
<table width="843" cellpadding="1" class="adminlist">
	<thead>
		<tr>
		  <th width="23%" height="45" rowspan="2">Kementerian/Lembaga</th>
			<th colspan="3"><font color="#0000FF">Sasaran Strategis</font></th>
		  <th colspan="2" rowspan="2"><a href="index.php?p=525" title="Input Sasaran Strategis">
							<img src="css/images/menu/add-icon.png" border="0" width="16" height="16">Input Sasaran Strategis</a></th>
		</tr>
		<tr>
	...
	<tbody><?php
		...
		<?php
			...
			<tr class="<?php echo $class ?>">
	          ...
	          <td colspan="3" align="left"><font color="#0000FF"><?php echo $col[2][$k] ?></font></td>
...
?>	  
		<tr>
		    ...
		    <td width="51%"  class="row6"><?php echo $List['nm_iku'] ?></td>
		    <td width="11%"  class="row6" align="center"><?php echo $List['target'] ?></td>
		    <td width="5%" align="center"><a href="index.php?p=521&q=<?php echo $List['id'] ?>" title="Edit Sasaran">
				  <img src="css/images/edit_f2.png" border="0" width="16" height="16"></a></td>
		    <td width="6%" align="center"><a href="index.php?p=522&q=<?php echo $List['id'] ?>" title="Delete Sasaran">
