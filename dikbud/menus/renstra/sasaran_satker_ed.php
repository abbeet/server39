	...
	{		
		...
		{	
			if ($q == "") 
			{
				...
				<meta http-equiv="refresh" content="0;URL=index.php?p=514"><?php
				exit();
			} 
			else {
				// UPDATE
...
<form action="index.php?p=<?php echo $_GET['p']; ?>&q=<?php echo $q ?>" method="post" name="form">
	<table width="803" cellspacing="1" class="admintable">
		...
		<tr>
			<td width="173" class="key">Satker Mandiri </td>
			<td width="621">
			<select name="kdunit">
					...
					switch ( $xlevel )
					{
						case 3 :
							...
							break;
						default :
							$query = mysql_query("select kdunit, nmunit from tb_unitkerja where kdunit > '2320600' and kdsatker <> '' order by kdunit");
							break;
					}	
...
switch ( $xlevel )
{
	...
	default :
	$sql = "SELECT * FROM $table WHERE ta = '$th' and kdunit > '2320600' ORDER BY kdunit,no_sasaran";
	break;
}
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
					...
					<td width="7%" align="center">
						<a href="index.php?p=514&q=<?php echo $col[0][$k]; ?>" title="Edit">
					<img src="css/images/edit_f2.png" border="0" width="16" height="16">						</a>					</td>
					<td width="11%" align="center">
						<a href="index.php?p=515&q=<?php echo $col[0][$k]; ?>" title="Delete">
