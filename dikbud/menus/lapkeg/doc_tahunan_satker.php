...
<table width="884" cellpadding="1">
  <thead>
    <tr>
      <th colspan="3" align="left"><font size="4" color="#FF00FF">LAPORAN TAHUNAN<br />
  ...
  <tbody>
    ...
    <tr >
      <td width="32%" align="center" valign="top" class="row7"><img src="<?php echo 'file_tahunan/'.$xkdunit.'/'.cover_tahunan($th,$xkdunit) ?>" border="1" width="220" height="300"><br /><br />
	  <div class="button2-left"> 
<div class="next"><a onclick="Back('index.php?p=601&xkdunit=<?php echo $xkdunit ?>')">Update</a></div>
</div>	  </td> 
	  ...
	  <font size="2" color="#660033"><?php 
	  	$oList = mysql_query("select * from $table where nourut <> 0 and th = '$th' and kdunitkerja = '$xkdunit' and keterangan = 'Tahunan' order by nourut");	
	while($List = mysql_fetch_array($oList))
    { ?>
	  <a href= "index.php?p=602&kdunit=<?php  echo "$List[kdunitkerja]" ?>&nourut=<?php echo "$List[nourut]" ?>&nama=<?php echo "$List[nama_file]" ?>" ><font size="2"><?php echo '=> '.$List['dafisi'] ?></font></a><br>
	<?php
	}  
	  ?></font>	  </td>
      <td width="40%" align="left" valign="top" class="row6"><br />
      <font color="#FF00FF" size="3"><strong>Visi :</strong></font><br /><strong><?php echo visi_unit($xkdunit) ?></strong><br /><br />
      <font color="#FF00FF" size="3"><strong>Misi :</strong></font><br /><strong>
	  <?php 	
		...
		?>
	  <br />
      <font color="#FF00FF" size="3"><strong>Tugas Pokok :</strong></font><br /><strong>
