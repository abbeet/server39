...
<table width="884" cellpadding="1">
  <thead>
    <tr>
      <th colspan="3" align="left"><font size="4" color="#0000FF">LAPORAN SEMESTER I<br /><?php echo nm_unit($xkdunit).'<br> Tahun '.$th ?></font></th> 
      </tr>
  </thead>
  <tbody>
...
<div class="next"><a onclick="Back('index.php?p=589&xkdunit=<?php echo $xkdunit ?>')">Update</a></div>
</div>	  </td> 
    ...
    { ?>
	  <a href= "index.php?p=590&kdunit=<?php  echo "$List[kdunitkerja]" ?>&nourut=<?php echo "$List[nourut]" ?>&nama=<?php echo "$List[nama_file]" ?>" ><font size="2"><?php echo '=> '.$List['dafisi'] ?></font></a><br>
	<?php
	}  
	  ?></font>	  </td>
      <td width="40%" align="left" valign="top" class="row6"><br />
      <font color="#0000FF" size="3"><strong>Visi :</strong></font><br /><strong><?php echo visi_unit($xkdunit) ?></strong><br /><br />
