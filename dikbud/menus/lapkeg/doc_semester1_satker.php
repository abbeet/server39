...
<div class="next"><a onclick="Back('index.php?p=603&xkdunit=<?php echo $xkdunit ?>')">Update</a></div>
</div>	  </td> 
    ...
    { ?>
	  <a href= "index.php?p=604&kdunit=<?php  echo "$List[kdunitkerja]" ?>&nourut=<?php echo "$List[nourut]" ?>&nama=<?php echo "$List[nama_file]" ?>" ><font size="2"><?php echo '=> '.$List['dafisi'] ?></font></a><br>
	<?php
	}  
	  ?></font>	  </td>
