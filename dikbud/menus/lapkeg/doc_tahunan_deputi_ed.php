	...
	{		
		if ($err != true) 
		{
			...
			if ($_FILES['nmfile']['name'] != "")
			{
				...
				$filedir = "file_tahunan/".$xkdunit."/".$th.'_'.$filename ;
				move_uploaded_file($_FILES["nmfile"]["tmp_name"], $filedir);
				//-------- simpan data ------
				$tgl_upload = date ('Y-m-d H:i:s') ;
				$sql = mysql_query("select * from dt_fileupload WHERE th = '$th' and kdunitkerja = '$xkdunit' and nourut = '$nourut' and keterangan = 'Tahunan' ");
				$row = mysql_fetch_array($sql);
				if(empty($row)){
					$sql = "INSERT INTO dt_fileupload (id,th,kdunitkerja,nourut,dafisi,nama_file,keterangan,tgl_upload,user_upload) values ('','$th','$xkdunit','$nourut','$dafisi','$nm_filename','Tahunan', '$tgl_upload','$xusername')";				
					$query = mysql_query($sql) or die(mysql_error());
				}else{
					$sql = "UPDATE dt_fileupload SET dafisi = '$dafisi', nama_file = '$nm_filename', tgl_upload = '$tgl_upload', user_upload = '$xusername' WHERE th = '$th' and kdunitkerja = '$xkdunit' and nourut = '$nourut' and keterangan = 'Tahunan' ";				
					$query = mysql_query($sql) or die(mysql_error());
				}
				//--------------------
			...
			<meta http-equiv="refresh" content="0;URL=index.php?p=593&xkdunit=<?php echo $xkdunit ?>"><?php
			exit();
	...
	function form_proses()
		{
            ...
            <form action="index.php?p=593&xkdunit=<?php echo $xkdunit ?>" method="post" name="xproses" enctype="multipart/form-data">
  ...
  <table cellspacing="1" class="admintable">
    ...
    <tr> 
      ...
      <td> <div class="button2-right"> 
          <div class="prev"><a onclick="Back('index.php?p=<?php echo $p_next ?>&xkdunit=<?php echo $xkdunit ?>')">Kembali</a></div>
        </div>
...
<?php
	$sql = "select * from dt_fileupload WHERE th = '$th' and kdunitkerja = '$xkdunit' and keterangan = 'Tahunan' order by nourut";
...
?>
<table width="663" cellpadding="1" class="adminlist">
  <thead>
    <tr>
      ...
      <th width="7%" rowspan="2">Nama File </th>
    </tr>
    <tr>
  ...
  <tbody>
    ...
    <tr class="<?php echo $class ?>">
      <td width="9%" align="center"><?php echo $col[5][$k]?></td> 
      <td width="46%" align="left"><?php echo nm_unit($col[7][$k]) ?></td>
      <td width="8%" align="center"><?php echo $col[6][$k]?></td>
      <td width="15%" align="left"><?php echo $col[1][$k]?></td>
      <td width="6%" align="left"><?php echo $col[2][$k]?></td>
