...
switch ( $xlevel )
{
	...
	default :
	$query = mysql_query("select * from tb_unitkerja where kdunit > '2320600' and kdsatker <> '' and left(nmunit,5) <> 'DINAS' order by kdunit");
	break ;
}					
...
<div class="next"><a onclick="Back('index.php?p=597&xkdunit=<?php echo $xkdunit ?>')">Update</a></div>
</div>	  </td> 
    ...
    { ?>
	  <a href= "index.php?p=598&kdunit=<?php  echo "$List[kdunitkerja]" ?>&nourut=<?php echo "$List[nourut]" ?>&nama=<?php echo "$List[nama_file]" ?>" ><font size="2"><?php echo '=> '.$List['dafisi'] ?></font></a><br>
	<?php
	}  
	  ?></font>	  </td>
      <td width="40%" align="left" valign="top" class="row6"><br />
      <font color="#FF9900" size="3"><strong>Visi :</strong></font><br /><strong><?php echo visi_unit($xkdunit) ?></strong><br /><br />
      <font color="#FF9900" size="3"><strong>Misi :</strong></font><br /><strong>
	  <?php 	
		...
		?>
	  <br />
      <font color="#FF9900" size="3"><strong>Tugas Pokok :</strong></font><br /><strong>
