<?php
	...
	{		
		if ($err != true) 
		{
			...
			<meta http-equiv="refresh" content="0;URL=index.php?p=601&xkdunit=<?php echo $xkdunit ?>"><?php
			exit();
	...
	function form_proses()
		{
            ...
            <form action="index.php?p=601&xkdunit=<?php echo $xkdunit ?>" method="post" name="xproses" enctype="multipart/form-data">
