				...
				<tr class="row1">
				  ...
				  <td colspan="2" align="left" valign="top"><?php echo $col[3][$k] ?></td>
					<td colspan="2" align="center" valign="top">
						<a href="index.php?p=575&q=<?php echo $col[0][$k] ?>" title="Edit Visi">
							<img src="css/images/edit_f2.png" border="0" width="16" height="16"></a></td>
				</tr>
				<tr class = "row1">
				  <td align="left" valign="top">&nbsp;</td>
				  <td colspan="2" align="center" valign="top"><strong>Misi<strong></td>
				  <td colspan="2" align="center" valign="top"><a href="index.php?p=576&kdunit=<?php echo $col[1][$k] ?>" title="Tambah Misi">
...
?>				
				<tr>
				  ...
				  <td align="center" valign="top"><a href="index.php?p=576&q=<?php echo $Misi['id'] ?>" title="Edit Misi">
				  <img src="css/images/edit_f2.png" border="0" width="16" height="16"></a></td>
	              <td align="center" valign="top"><a href="index.php?p=577&q=<?php echo $Misi['id'] ?>" title="Delete Misi">
				...
				<tr class = "row1">
				  ...
				  <td colspan="2" align="center" valign="top"><a href="index.php?p=578&kdunit=<?php echo $col[1][$k] ?>" title="Tambah Tujuan">
	  		...
	  		<?php
				...
				<tr>
				  ...
				  <td align="center" valign="top"><a href="index.php?p=578&q=<?php echo $Tujuan['id'] ?>" title="Edit Tujuan">
				  <img src="css/images/edit_f2.png" border="0" width="16" height="16"></a></td>
				  <td align="center" valign="top"><a href="index.php?p=579&q=<?php echo $Tujuan['id'] ?>" title="Delete Tujuan">
							<img src="css/images/stop_f2.png" border="0" width="16" height="16"></a></td>
				  <?php
			} # akhir tujuan
			?>
