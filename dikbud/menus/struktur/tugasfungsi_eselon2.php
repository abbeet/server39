...
switch ( $xlevel )
{
	...
	default :
	$query = "SELECT COUNT(*) as num FROM $table WHERE ( kdunit = '2320100' or kdunit = '2320200' or kdunit = '2320300' or kdunit = '2320400' or kdunit = '2320500' or kdunit = '2320600') and (nmunit LIKE '%$cari%' OR kdunit LIKE '%$cari%' OR tugas LIKE '%$cari%') ";
	break ;
}	
...
switch ( $xlevel )
{
	...
	default :
	$oList = mysql_query("SELECT * FROM $table WHERE ( kdunit = '2320100' or kdunit = '2320200' or kdunit = '2320300' or kdunit = '2320400' or kdunit = '2320500' or kdunit = '2320600') and (nmunit LIKE '%$cari%' OR kdunit LIKE '%$cari%' OR tugas LIKE '%$cari%') ORDER BY kdunit LIMIT $start, $limit");
	break ;
}
...
<div align="right">
	<form action="" method="get">
		...
		<a href="index.php?p=486">Reset</a>
	</form>
</div><br />
<table width="443" cellpadding="1" class="adminlist">
	<thead>
		<tr>
			<th width="18%">Eselon II</th>
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="row1">
				  ...
				  <td colspan="2" align="left" valign="top"><?php echo $col[3][$k] ?></td>
					<td colspan="2" align="center" valign="top"><a href="index.php?p=506&q=<?php echo $col[0][$k] ?>" title="Edit Tugas Pokok">
				  <img src="css/images/edit_f2.png" border="0" width="16" height="16"></a></td>
				</tr>
				<tr class="row1">
				  <td align="center" valign="top">&nbsp;</td>
				  <td colspan="2" align="center" valign="top"><strong>Fungsi</strong></td>
				  <td colspan="2" align="center" valign="top"><a href="index.php?p=507&kdunit=<?php echo $col[1][$k] ?>" title="Tambah Fungsi">
...
?>				
				<tr class="row0">
				  ...
				  <td align="center" valign="top"><a href="index.php?p=507&q=<?php echo $Fungsi['id'] ?>" title="Edit Fungsi">
				  <img src="css/images/edit_f2.png" border="0" width="16" height="16"></a></td>
	              <td align="center" valign="top"><a href="index.php?p=508&q=<?php echo $Fungsi['id'] ?>" title="Delete Fungsi">
