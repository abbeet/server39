<?php
	...
	$query = "SELECT COUNT(*) as num FROM $table WHERE kdunit = '$kdmenteri' and (nmunit LIKE '%$cari%' OR kdunit LIKE '%$cari%' OR tugas LIKE '%$cari%') ";
	...
	$oList = mysql_query("SELECT * FROM $table WHERE kdunit = '$kdmenteri' and (nmunit LIKE '%$cari%' OR kdunit LIKE '%$cari%' OR tugas LIKE '%$cari%') ORDER BY kdunit LIMIT $start, $limit");
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
				  ...
				  <td colspan="2" align="left" valign="top"><?php echo $col[3][$k] ?></td>
					<td colspan="2" align="center" valign="top"><a href="index.php?p=500&q=<?php echo $col[0][$k] ?>" title="Edit Tugas Pokok">
				...
				<tr class="<?php echo $class ?>">
				  ...
				  <td colspan="2" align="center" valign="top"><a href="index.php?p=501&kdunit=<?php echo $col[1][$k] ?>" title="Tambah Fungsi">
...
?>				
				<tr>
				  ...
				  <td align="center" valign="top"><a href="index.php?p=501&q=<?php echo $Fungsi['id'] ?>" title="Edit Fungsi">
				  <img src="css/images/edit_f2.png" border="0" width="16" height="16"></a></td>
	              <td align="center" valign="top"><a href="index.php?p=502&q=<?php echo $Fungsi['id'] ?>" title="Delete Fungsi">
