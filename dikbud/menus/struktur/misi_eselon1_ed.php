	...
	{		
		...
		{	
			if ($q == "") 
			{
				...
				<meta http-equiv="refresh" content="0;URL=index.php?p=495&kdunit=<?php echo $kdunit ?>"><?php
				exit();
			} 
			else {
				// UPDATE
		...
		{ ?>
			<meta http-equiv="refresh" content="0;URL=index.php?p=494&kdunit=<?php echo $kdunit ?>"><?php		
		}
	} 
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
					...
					<td width="7%" align="center">
						<a href="index.php?p=495&kdunit=<?php echo $kdunit; ?>&q=<?php echo $col[0][$k]; ?>" title="Edit">
							<img src="css/images/edit_f2.png" border="0" width="16" height="16">						</a>					</td>
					<td width="7%" align="center">
						<a href="index.php?p=496&kdunit=<?php echo $kdunit ?>&q=<?php echo $col[0][$k]; ?>" title="Delete">
