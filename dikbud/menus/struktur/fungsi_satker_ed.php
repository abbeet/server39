	...
	{		
		...
		{	
			if ($q == "") 
			{
				...
				<meta http-equiv="refresh" content="0;URL=index.php?p=581&kdunit=<?php echo $kdunit ?>"><?php
				exit();
			} 
			else {
				// UPDATE
		...
		<tr>
			...
			<td>			
				<div class="button2-right">
					<div class="prev">
						<a onclick="Back('index.php?p=534')"><?php echo $batal ?></a>					</div>
				</div>
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
					...
					<td width="7%" align="center">
						<a href="index.php?p=581&kdunit=<?php echo $kdunit; ?>&q=<?php echo $col[0][$k]; ?>" title="Edit">
							<img src="css/images/edit_f2.png" border="0" width="16" height="16">						</a>					</td>
					<td width="7%" align="center">
						<a href="index.php?p=582&kdunit=<?php echo $kdunit ?>&q=<?php echo $col[0][$k]; ?>" title="Delete">
