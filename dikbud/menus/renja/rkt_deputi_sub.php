	...
	{		
		...
		{	
			if ($q == "") 
			{
				...
				<meta http-equiv="refresh" content="0;URL=index.php?p=399&id=<?php echo $id ?>&xkdunit=<?php echo $xkdunit ?>"><?php
				exit();
			} 
			else {
				// UPDATE
				...
				<meta http-equiv="refresh" content="0;URL=index.php?p=375&xkdunit=<?php echo $xkdunit ?>"><?php
				exit();
				}
			}
		}
...
<form action="index.php?p=399&id=<?php echo $id ?>&xkdunit=<?php echo $xkdunit ?>&sw=<?php echo $sw ?>" method="post" name="form">
  ...
  <table cellspacing="1" class="admintable">
    ...
    <tr> 
      ...
      <td colspan="2">
		...
		<input type="button" onclick="Back('index.php?p=375&xkdunit=<?php echo $xkdunit ?>')" value="Kembali" />
...
<?php
	...
	$aSub = mysql_query($sql);
	$count = mysql_num_rows($aSub);

	while ($Sub = mysql_fetch_array($aSub))
	{
?>
    <tr class="<?php echo $class ?>"> 
      <td align="center"><?php echo $Sub['no_rkt_sub'] ?></td>
      <td align="left"><?php echo $Sub['nm_rkt_sub'] ?></td>
      <td align="center"><?php echo $Sub['target'] ?></td>
      <td width="4%" align="center"> <a href="index.php?p=399&id=<?php echo $id ?>&q=<?php echo $Sub['id'] ?>&xkdunit=<?php echo $xkdunit ?>" title="Edit"> 
        <img src="css/images/edit_f2.png" border="0" width="16" height="16"> </a>      </td>
      <td width="6%" align="center"><a href="index.php?p=400&id=<?php echo $id ?>&q=<?php echo $Sub['id'] ?>&xkdunit=<?php echo $xkdunit ?>" title="Delete"> 
