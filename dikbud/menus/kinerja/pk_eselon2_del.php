...
<table cellspacing="1" class="admintable">
  ...
  <tr> 
    ...
    <td><textarea readonly="readonly" cols="70" rows="1"><?php echo nm_unit($value[2]) ?></textarea></td>
  </tr>
  <tr> 
  ...
  <tr> 
    ...
    <td><textarea readonly="readonly" cols="70" rows="1"><?php echo $value[5] ?></textarea></td>
  </tr>
  <tr>
    <td class="key">Target</td>
    <td><input name="text" type="text" value="<?php echo $value[6] ?>" size="50" readonly="readonly" /></td>
  </tr>
  <tr>
    <td class="key">&nbsp;</td>
    <td>&nbsp;</td>
