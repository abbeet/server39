...
<form action="index.php?p=<?php echo $_GET['p'] ?>" method="post" name="form">
  ...
  <table width="693" cellspacing="1" class="admintable">
    ...
    <tr> 
      <td width="98" class="key">No. Urut </td>
    ...
    <tr>
      <td colspan="5" align="center"><strong>RENCANA AKSI:</strong></td>
    </tr>
    <tr>
      <td class="key" valign="top">Triwulan I</td>
      <td width="47" valign="top" align="right">Progres</td>
      <td width="101" valign="top"><input type="text" name="rencana_1" size="5" value="<?php echo $List['rencana_1'] ?>" />&nbsp;%</td>
      <td width="50" valign="top" align="right">Uraian</td>
      <td width="379" valign="top"><textarea name="aksi_1" rows="3" cols="60" ><?php echo $List['aksi_1'] ?></textarea></td>
    </tr>
    <tr>
      ...
      <td width="379" valign="top"><textarea name="aksi_2" rows="3" cols="60" ><?php echo $List['aksi_2'] ?></textarea></td>
    </tr>
    <tr>
      ...
      <td valign="top" align="right">Uraian</td>
      <td width="379" valign="top"><textarea name="aksi_3" rows="3" cols="60" ><?php echo $List['aksi_3'] ?></textarea></td>
    </tr>
    <tr>
      ...
      <td valign="top" align="right">Uraian</td>
      <td width="379" valign="top"><textarea name="aksi_4" rows="3" cols="60" ><?php echo $List['aksi_4'] ?></textarea></td>
    </tr>
