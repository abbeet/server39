...
<table width="509" cellspacing="1" class="admintable">
	...
	<tr>
	  ...
	  <td><textarea readonly="readonly" cols="60" rows="2"><?php echo nm_sasaran($value[1],$value[2],$value[6]) ?></textarea></td>
  </tr>
	<tr>
	  <td class="key">IKU</td>
	  <td><textarea readonly="readonly" cols="60" rows="2"><?php echo nm_iku($value[1],$value[5]) ?></textarea></td>
  </tr>
	<tr>
	...
	<tr>
		...
		<td><textarea readonly="readonly" cols="60" rows="2"><?php echo $value[4] ?></textarea></td>
	</tr>
	<tr>
