	...
	{		
		...
		{	
			if ($q == "") 
			{
				...
				<meta http-equiv="refresh" content="0;URL=index.php?p=430&id=<?php echo $id ?>&xkdunit=<?php echo $xkdunit ?>"><?php
				exit();
			} 
			else {
				// UPDATE
				...
				<meta http-equiv="refresh" content="0;URL=index.php?p=420&xkdunit=<?php echo $xkdunit ?>"><?php
				exit();
				}
			}
		}
...
<form action="index.php?p=430&id=<?php echo $id ?>&xkdunit=<?php echo $xkdunit ?>&sw=<?php echo $sw ?>" method="post" name="form">
  ...
  <table cellspacing="1" class="admintable">
    ...
    <tr>
      ...
      <td colspan="2"><textarea name="nm_sasaran" cols="70" rows="2" disabled="disabled"><?php echo nm_sasaran($th,'480000',$PK['no_sasaran']) ?></textarea></td>
    </tr>
    ...
    <tr> 
      ...
      <td colspan="2">
		...
		<input type="button" onclick="Back('index.php?p=420&xkdunit=<?php echo $xkdunit ?>')" value="Kembali" />
...
?>
    <tr class="<?php echo $class ?>"> 
      ...
      <td width="4%" align="center"> <a href="index.php?p=430&id=<?php echo $id ?>&q=<?php echo $SubPK['id'] ?>&xkdunit=<?php echo $xkdunit ?>" title="Edit"> 
        <img src="css/images/edit_f2.png" border="0" width="16" height="16"> </a>      </td>
      <td width="6%" align="center"><a href="index.php?p=431&id=<?php echo $id ?>&q=<?php echo $SubPK['id'] ?>&xkdunit=<?php echo $xkdunit ?>" title="Delete"> 
