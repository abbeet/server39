...
<form action="index.php?p=<?php echo $_GET['p'] ?>" method="post" name="form">
  ...
  <table width="693" cellspacing="1" class="admintable">
    ...
    <tr> 
      <td width="99" class="key">No. Urut </td>
      <td colspan="2"><input type="text" name="no_pk" size="5" value="<?php echo $List['no_pk'] ?>" disabled="disabled"/></td>
    </tr>
    <tr> 
      <td class="key">Kinerja</td>
      <td colspan="2"><textarea name="nm_pk" rows="3" cols="60" disabled="disabled"><?php echo $List['nm_pk'] ?></textarea></td>
    </tr>
    <tr>
      <td class="key"><strong>RENCANA AKSI:</strong></td>
      <td colspan="2">&nbsp;</td>
    </tr>
    <tr>
      <td class="key" valign="top">Triwulan I</td>
      <td width="92" valign="top"><input type="text" name="rencana_1" size="8" value="<?php echo $List['rencana_1'] ?>" />&nbsp;%	  </td>
      <td width="490" valign="top"><textarea name="aksi_1" rows="3" cols="60" ><?php echo $List['aksi_1'] ?></textarea></td>
    </tr>
    <tr>
      <td class="key" valign="top">Triwulan II</td>
      <td width="92" valign="top"><input type="text" name="rencana_2" size="8" value="<?php echo $List['rencana_2'] ?>" />&nbsp;%	  </td>
      <td width="490" valign="top"><textarea name="aksi_2" rows="3" cols="60" ><?php echo $List['aksi_2'] ?></textarea></td>
    </tr>
    <tr>
      <td class="key" valign="top">Triwulan III</td>
      <td width="92" valign="top"><input type="text" name="rencana_3" size="8" value="<?php echo $List['rencana_3'] ?>" />&nbsp;%	  </td>
      <td width="490" valign="top"><textarea name="aksi_3" rows="3" cols="60" ><?php echo $List['aksi_3'] ?></textarea></td>
    </tr>
    <tr>
      <td class="key" valign="top">Triwulan IV</td>
      <td width="92" valign="top"><input type="text" name="rencana_4" size="8" value="<?php echo $List['rencana_4'] ?>" />&nbsp;%	  </td>
      <td width="490" valign="top"><textarea name="aksi_4" rows="3" cols="60" ><?php echo $List['aksi_4'] ?></textarea></td>
    </tr>
    
    <tr> 
      <td>&nbsp;</td>
      <td colspan="2"> <div class="button2-right"> 
