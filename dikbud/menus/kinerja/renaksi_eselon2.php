...
<table width="806" cellpadding="1" class="adminlist">
  ...
  <tbody>
    ...
    <tr class="<?php echo $class ?>">
      ...
      <td width="3%" align="center" valign="top"><a href="index.php?p=617&q=<?php echo $col[0][$k] ?>" title="Edit"> 
        <img src="css/images/edit_f2.png" border="0" width="16" height="16"> </a></td>
      <td width="7%" align="center" valign="top"><a href="index.php?p=618&q=<?php echo $col[0][$k] ?>" title="Delete"> 
