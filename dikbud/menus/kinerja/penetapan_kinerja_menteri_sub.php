<?php
	...
	{		
		...
		{	
			if ($q == "") 
			{
				...
				$sql = "INSERT INTO $table (id,th,kdunitkerja,no_pk,no_pk_sub,nm_pk_sub,target) VALUE
				 ('','$th','480000','$PK[no_pk]','$no_pk_sub','$nm_pk_sub','$target')";
				$rs = mysql_query($sql);
				...
				?>
				<meta http-equiv="refresh" content="0;URL=index.php?p=426&id=<?php echo $id ?>"><?php
				exit();
			} 
			else {
				// UPDATE
		...
		{ ?>
			<meta http-equiv="refresh" content="0;URL=index.php?p=426&no_pk=<?php echo $no_pk ?>"><?php		
		}
	}
...
<form action="index.php?p=426&id=<?php echo $id ?>&sw=<?php echo $sw ?>" method="post" name="form">
  ...
  <table cellspacing="1" class="admintable">
    ...
    <tr>
      ...
      <td colspan="2"><textarea name="nm_sasaran" cols="70" rows="2" disabled="disabled"><?php echo nm_sasaran($PK['th'],'480000',$PK['no_sasaran']) ?></textarea></td>
    </tr>
    ...
    <tr> 
      ...
      <td colspan="2">
		...
		<input type="button" onclick="Back('index.php?p=418')" value="Kembali" />
...
width="5%" height="61">No.</th>
  ...
  <tbody>
<?php
	$sql = "SELECT * FROM $table WHERE th = '$th' AND kdunitkerja = '480000' and no_pk = '$PK[no_pk]' ORDER BY no_pk_sub";
...
?>
    <tr class="<?php echo $class ?>"> 
      ...
      <td width="4%" align="center"> <a href="index.php?p=426&id=<?php echo $id ?>&q=<?php echo $SubPK['id'] ?>" title="Edit"> 
        <img src="css/images/edit_f2.png" border="0" width="16" height="16"> </a>      </td>
      <td width="6%" align="center"><a href="index.php?p=427&id=<?php echo $id ?>&q=<?php echo $SubPK['id'] ?>" title="Delete"> 
