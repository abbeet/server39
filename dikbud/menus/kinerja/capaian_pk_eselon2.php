...
<div align="right">
	<form action="index.php?p=539&kdtriwulan=<?php echo $kdtriwulan ?>&xkdunit=<?php echo $xkdunit ?>" method="post">
...
<table width="806" cellpadding="1" class="adminlist">
  <thead>
    ...
    <tr>
      <th width="18%" rowspan="2">Eselon II</th>
...
<?php 
      ...
      <td width="3%" align="center" valign="top"><a href="index.php?p=623&q=<?php echo $col[0][$k] ?>&kdtriwulan=<?php echo $kdtriwulan ?>" title="Edit"> 
        <img src="css/images/edit_f2.png" border="0" width="16" height="16"> </a></td>
      <td width="7%" align="center" valign="top"><a href="index.php?p=624&q=<?php echo $col[0][$k] ?>&kdtriwulan=<?php echo $kdtriwulan ?>" title="Delete"> 
