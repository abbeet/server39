...
//	$sql = "select KDGIAT, sum(jumlah) as pagu_giat from $table  WHERE THANG = '$th' AND KDSATKER = '$kdsatker' group by KDGIAT";
	...
	{
	$real_output_triwulan = real_output_triwulan($th,$col[0][$k],$Giat['KDGIAT'],$Output['KDOUTPUT'],$kdtriwulan) ;
	$real_output_sdtriwulan = real_output_sdtriwulan($th,$col[0][$k],$Giat['KDGIAT'],$Output['KDOUTPUT'],$kdtriwulan) ;
	?>
    <tr class="<?php echo $class ?>">
      ...
      <td align="right" valign="top"><font color="#993333"><?php echo number_format($real_output_triwulan,"0",",",".") ?></font></td>
