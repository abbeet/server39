...
if ( $xlevel <> 3 and $xlevel <> 4 and $xlevel <> 5 and $xlevel <> 6 and $xlevel <> 7 and $xlevel <> 8 )
	...
	$real_menteri_sdbulan_51 = real_menteri_spm_sdbulan_jnsbel($th,$kddept,$kdunit,$kdbulan,'51') ;
	$real_menteri_sdbulan_52 = real_menteri_spm_sdbulan_jnsbel($th,$kddept,$kdunit,$kdbulan,'52') ;
	$real_menteri_sdbulan_53 = real_menteri_spm_sdbulan_jnsbel($th,$kddept,$kdunit,$kdbulan,'53') ;
	$real_menteri_sdbulan_524 = real_menteri_spm_sdbulan_jnsbel($th,$kddept,$kdunit,$kdbulan,'524') ;
	$real_menteri_sdbulan_57 = real_menteri_spm_sdbulan_jnsbel($th,$kddept,$kdunit,$kdbulan,'57') ;
  ...
  ?>
	...
	$real_satker_sdbulan_51 = real_satker_spm_sdbulan_jnsbel($th,$col[1][$k],$kdbulan,'51') ;
	$real_satker_sdbulan_52 = real_satker_spm_sdbulan_jnsbel($th,$col[1][$k],$kdbulan,'52') ;
	$real_satker_sdbulan_53 = real_satker_spm_sdbulan_jnsbel($th,$col[1][$k],$kdbulan,'53') ;
	$real_satker_sdbulan_524 = real_satker_spm_sdbulan_jnsbel($th,$col[1][$k],$kdbulan,'524') ;
	$real_satker_sdbulan_57 = real_satker_spm_sdbulan_jnsbel($th,$col[1][$k],$kdbulan,'57') ;
	...
	$real_giat_sdbulan_51 = real_giat_spm_sdbulan_jnsbel($th,$kdsatker,$Giat['KDGIAT'],$kdbulan,'51') ;
	$real_giat_sdbulan_52 = real_giat_spm_sdbulan_jnsbel($th,$kdsatker,$Giat['KDGIAT'],$kdbulan,'52') ;
	$real_giat_sdbulan_53 = real_giat_spm_sdbulan_jnsbel($th,$kdsatker,$Giat['KDGIAT'],$kdbulan,'53') ;
	$real_giat_sdbulan_524 = real_giat_spm_sdbulan_jnsbel($th,$kdsatker,$Giat['KDGIAT'],$kdbulan,'524') ;
	$real_giat_sdbulan_57 = real_giat_spm_sdbulan_jnsbel($th,$kdsatker,$Giat['KDGIAT'],$kdbulan,'57') ;
...
?>
    <tr class="<?php echo $class ?>">
      ...
      <td align="center" valign="top"><font color="#0033CC"><?php echo number_format($real_giat/$Giat['pagu_giat']*100,"2",",",".") ?></font></td>
	...
	$real_output_sdbulan_51 = real_output_spm_sdbulan_jnsbel($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],$kdbulan,'51') ;
	$real_output_sdbulan_52 = real_output_spm_sdbulan_jnsbel($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],$kdbulan,'52') ;
	$real_output_sdbulan_53 = real_output_spm_sdbulan_jnsbel($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],$kdbulan,'53') ;
	$real_output_sdbulan_524 = real_output_spm_sdbulan_jnsbel($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],$kdbulan,'524') ;
	$real_output_sdbulan_57 = real_output_spm_sdbulan_jnsbel($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],$kdbulan,'57') ;
