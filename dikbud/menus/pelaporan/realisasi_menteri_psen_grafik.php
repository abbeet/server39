...
$real_1 = real_menteri_sdbulan($th,1)/$Giat['RPHPAGU']*100 ;
$real_2 = real_menteri_sdbulan($th,2)/$Giat['RPHPAGU']*100 ;
$real_3 = real_menteri_sdbulan($th,3)/$Giat['RPHPAGU']*100 ;
$real_4 = real_menteri_sdbulan($th,4)/$Giat['RPHPAGU']*100 ;
$real_5 = real_menteri_sdbulan($th,5)/$Giat['RPHPAGU']*100 ;
$real_6 = real_menteri_sdbulan($th,6)/$Giat['RPHPAGU']*100 ;
$real_7 = real_menteri_sdbulan($th,7)/$Giat['RPHPAGU']*100 ;
$real_8 = real_menteri_sdbulan($th,8)/$Giat['RPHPAGU']*100 ;
$real_9 = real_menteri_sdbulan($th,9)/$Giat['RPHPAGU']*100 ;
$real_10 = real_menteri_sdbulan($th,10)/$Giat['RPHPAGU']*100 ;
$real_11 = real_menteri_sdbulan($th,11)/$Giat['RPHPAGU']*100 ;
$real_12 = real_menteri_sdbulan($th,12)/$Giat['RPHPAGU']*100 ;
