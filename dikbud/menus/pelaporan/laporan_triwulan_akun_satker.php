...
<table width="787" cellpadding="1" class="adminlist">
  ...
  ?>
    ...
    <tr class="<?php echo $class ?>">
      ...
      <td align="right" valign="top"><font color="#0000FF"><?php echo number_format($real_satker_triwulan_akun,"0",",",".") ?></font></td>
      <td align="right" valign="top"><font color="#0000FF"><?php echo number_format($real_satker_sdtriwulan_akun,"0",",",".") ?></font></td>
      <td align="center" valign="top"><?php if ( $Akun['pagu_akun'] <> 0 ) {?><font color="#0000FF"><?php echo number_format($real_satker_sdtriwulan_akun/$Akun['pagu_akun']*100,"2",",",".") ?></font><?php } ?></td>
      <td align="right" valign="top"><font color="#0000FF"><?php echo number_format($Akun['pagu_akun']-$real_satker_sdtriwulan_akun,"0",",",".") ?></font></td>
    </tr>
    <?php
		} // AKUN
		} // SATKER
