...
if ( $xlevel <> 3 and $xlevel <> 4 and $xlevel <> 5 and $xlevel <> 6 and $xlevel <> 7 and $xlevel <> 8 )
	...
	$real_menteri_bulan_1 = real_menteri_spm_bulan($th,$kddept,$kdunit,1) ;
	$real_menteri_bulan_2 = real_menteri_spm_bulan($th,$kddept,$kdunit,2) ;
	$real_menteri_bulan_3 = real_menteri_spm_bulan($th,$kddept,$kdunit,3) ;
	$real_menteri_bulan_4 = real_menteri_spm_bulan($th,$kddept,$kdunit,4) ;
	$real_menteri_bulan_5 = real_menteri_spm_bulan($th,$kddept,$kdunit,5) ;
	$real_menteri_bulan_6 = real_menteri_spm_bulan($th,$kddept,$kdunit,6) ;
	$real_menteri_bulan_7 = real_menteri_spm_bulan($th,$kddept,$kdunit,7) ;
	$real_menteri_bulan_8 = real_menteri_spm_bulan($th,$kddept,$kdunit,8) ;
	$real_menteri_bulan_9 = real_menteri_spm_bulan($th,$kddept,$kdunit,9) ;
	$real_menteri_bulan_10 = real_menteri_spm_bulan($th,$kddept,$kdunit,10) ;
	$real_menteri_bulan_11 = real_menteri_spm_bulan($th,$kddept,$kdunit,11) ;
	$real_menteri_bulan_12 = real_menteri_spm_bulan($th,$kddept,$kdunit,12) ;
	$real_menteri_sdbulan = real_menteri_spm_sdbulan($th,$kddept,$kdunit,12) ;
  ?>
    <tr>
	...
	$aTarik = mysql_query($sql);
	$Tarik = mysql_fetch_array($aTarik);
	$real_satker_bulan_1 = real_satker_spm_bulan($th,$col[1][$k],1) ;
	$real_satker_bulan_2 = real_satker_spm_bulan($th,$col[1][$k],2) ;
	$real_satker_bulan_3 = real_satker_spm_bulan($th,$col[1][$k],3) ;
	$real_satker_bulan_4 = real_satker_spm_bulan($th,$col[1][$k],4) ;
	$real_satker_bulan_5 = real_satker_spm_bulan($th,$col[1][$k],5) ;
	$real_satker_bulan_6 = real_satker_spm_bulan($th,$col[1][$k],6) ;
	$real_satker_bulan_7 = real_satker_spm_bulan($th,$col[1][$k],7) ;
	$real_satker_bulan_8 = real_satker_spm_bulan($th,$col[1][$k],8) ;
	$real_satker_bulan_9 = real_satker_spm_bulan($th,$col[1][$k],9) ;
	$real_satker_bulan_10 = real_satker_spm_bulan($th,$col[1][$k],10) ;
	$real_satker_bulan_11 = real_satker_spm_bulan($th,$col[1][$k],11) ;
	$real_satker_bulan_12 = real_satker_spm_bulan($th,$col[1][$k],12) ;
	$real_satker_sdbulan = real_satker_spm_sdbulan($th,$col[1][$k],12) ;
	?>
	...
	{
	$real_giat_bulan_1 = real_giat_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],1) ;
	$real_giat_bulan_2 = real_giat_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],2) ;
	$real_giat_bulan_3 = real_giat_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],3) ;
	$real_giat_bulan_4 = real_giat_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],4) ;
	$real_giat_bulan_5 = real_giat_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],5) ;
	$real_giat_bulan_6 = real_giat_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],6) ;
	$real_giat_bulan_7 = real_giat_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],7) ;
	$real_giat_bulan_8 = real_giat_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],8) ;
	$real_giat_bulan_9 = real_giat_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],9) ;
	$real_giat_bulan_10 = real_giat_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],10) ;
	$real_giat_bulan_11 = real_giat_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],11) ;
	$real_giat_bulan_12 = real_giat_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],12) ;
	$real_giat_sdbulan = real_giat_spm_sdbulan($th,$kdsatker,$Giat['KDGIAT'],12) ;
	$kdgiat = $Giat['KDGIAT'] ;
	$sql = "select 	sum(RPHPAGU) as RPHPAGU,
					sum(JML01) as JML01,
					sum(JML02) as JML02,
...
?>
	...
	{
	$real_output_bulan_1 = real_output_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],1) ;
	$real_output_bulan_2 = real_output_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],2) ;
	$real_output_bulan_3 = real_output_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],3) ;
	$real_output_bulan_4 = real_output_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],4) ;
	$real_output_bulan_5 = real_output_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],5) ;
	$real_output_bulan_6 = real_output_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],6) ;
	$real_output_bulan_7 = real_output_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],7) ;
	$real_output_bulan_8 = real_output_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],8) ;
	$real_output_bulan_9 = real_output_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],9) ;
	$real_output_bulan_10 = real_output_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],10) ;
	$real_output_bulan_11 = real_output_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],11) ;
	$real_output_bulan_12 = real_output_spm_bulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],12) ;
	$real_output_sdbulan = real_output_spm_sdbulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],12) ;
?>
    <tr class="<?php echo $class ?>">
