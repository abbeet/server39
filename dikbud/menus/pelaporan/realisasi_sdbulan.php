...
if ( $xlevel <> 3 and $xlevel <> 4 and $xlevel <> 5 and $xlevel <> 6 and $xlevel <> 7 and $xlevel <> 8 )
	...
	$real_menteri_bulan_1 = real_menteri_sdbulan($th,1)/1000000 ;
	$real_menteri_bulan_2 = real_menteri_sdbulan($th,2)/1000000 ;
	$real_menteri_bulan_3 = real_menteri_sdbulan($th,3)/1000000 ;
	$real_menteri_bulan_4 = real_menteri_sdbulan($th,4)/1000000 ;
	$real_menteri_bulan_5 = real_menteri_sdbulan($th,5)/1000000 ;
	$real_menteri_bulan_6 = real_menteri_sdbulan($th,6)/1000000 ;
	$real_menteri_bulan_7 = real_menteri_sdbulan($th,7)/1000000 ;
	$real_menteri_bulan_8 = real_menteri_sdbulan($th,8)/1000000 ;
	$real_menteri_bulan_9 = real_menteri_sdbulan($th,9)/1000000 ;
	$real_menteri_bulan_10 = real_menteri_sdbulan($th,10)/1000000 ;
	$real_menteri_bulan_11 = real_menteri_sdbulan($th,11)/1000000 ;
	$real_menteri_bulan_12 = real_menteri_sdbulan($th,12)/1000000 ;
  ?>
    <tr>
	...
	$aTarik = mysql_query($sql);
	$Tarik = mysql_fetch_array($aTarik);
	$real_satker_bulan_1 = real_satker_sdbulan($th,$col[1][$k],1)/1000000 ;
	$real_satker_bulan_2 = real_satker_sdbulan($th,$col[1][$k],2)/1000000 ;
	$real_satker_bulan_3 = real_satker_sdbulan($th,$col[1][$k],3)/1000000 ;
	$real_satker_bulan_4 = real_satker_sdbulan($th,$col[1][$k],4)/1000000 ;
	$real_satker_bulan_5 = real_satker_sdbulan($th,$col[1][$k],5)/1000000 ;
	$real_satker_bulan_6 = real_satker_sdbulan($th,$col[1][$k],6)/1000000 ;
	$real_satker_bulan_7 = real_satker_sdbulan($th,$col[1][$k],7)/1000000 ;
	$real_satker_bulan_8 = real_satker_sdbulan($th,$col[1][$k],8)/1000000 ;
	$real_satker_bulan_9 = real_satker_sdbulan($th,$col[1][$k],9)/1000000 ;
	$real_satker_bulan_10 = real_satker_sdbulan($th,$col[1][$k],10)/1000000 ;
	$real_satker_bulan_11 = real_satker_sdbulan($th,$col[1][$k],11)/1000000 ;
	$real_satker_bulan_12 = real_satker_sdbulan($th,$col[1][$k],12)/1000000;
	?>
	...
	{
	$real_giat_bulan_1 = real_giat_sdbulan($th,$kdsatker,$Giat['KDGIAT'],1)/1000000 ;
	$real_giat_bulan_2 = real_giat_sdbulan($th,$kdsatker,$Giat['KDGIAT'],2)/1000000 ;
	$real_giat_bulan_3 = real_giat_sdbulan($th,$kdsatker,$Giat['KDGIAT'],3)/1000000 ;
	$real_giat_bulan_4 = real_giat_sdbulan($th,$kdsatker,$Giat['KDGIAT'],4)/1000000 ;
	$real_giat_bulan_5 = real_giat_sdbulan($th,$kdsatker,$Giat['KDGIAT'],5)/1000000 ;
	$real_giat_bulan_6 = real_giat_sdbulan($th,$kdsatker,$Giat['KDGIAT'],6)/1000000 ;
	$real_giat_bulan_7 = real_giat_sdbulan($th,$kdsatker,$Giat['KDGIAT'],7)/1000000 ;
	$real_giat_bulan_8 = real_giat_sdbulan($th,$kdsatker,$Giat['KDGIAT'],8)/1000000 ;
	$real_giat_bulan_9 = real_giat_sdbulan($th,$kdsatker,$Giat['KDGIAT'],9)/1000000 ;
	$real_giat_bulan_10 = real_giat_sdbulan($th,$kdsatker,$Giat['KDGIAT'],10)/1000000 ;
	$real_giat_bulan_11 = real_giat_sdbulan($th,$kdsatker,$Giat['KDGIAT'],11)/1000000 ;
	$real_giat_bulan_12 = real_giat_sdbulan($th,$kdsatker,$Giat['KDGIAT'],12)/1000000 ;
	$kdgiat = $Giat['KDGIAT'] ;
	$sql = "select 	sum(RPHPAGU) as RPHPAGU,
					sum(JML01) as JML01,
					sum(JML01+JML02) as JML02,
...
?>
	...
	{
	$real_output_bulan_1 = real_output_sdbulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],1)/1000000 ;
	$real_output_bulan_2 = real_output_sdbulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],2)/1000000 ;
	$real_output_bulan_3 = real_output_sdbulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],3)/1000000 ;
	$real_output_bulan_4 = real_output_sdbulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],4)/1000000 ;
	$real_output_bulan_5 = real_output_sdbulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],5)/1000000 ;
	$real_output_bulan_6 = real_output_sdbulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],6)/1000000 ;
	$real_output_bulan_7 = real_output_sdbulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],7)/1000000 ;
	$real_output_bulan_8 = real_output_sdbulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],8)/1000000 ;
	$real_output_bulan_9 = real_output_sdbulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],9)/1000000 ;
	$real_output_bulan_10 = real_output_sdbulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],10)/1000000 ;
	$real_output_bulan_11 = real_output_sdbulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],11)/1000000 ;
	$real_output_bulan_12 = real_output_sdbulan($th,$kdsatker,$Giat['KDGIAT'],$Output['KDOUTPUT'],12)/1000000 ;
?>
    <tr class="<?php echo $class ?>">
