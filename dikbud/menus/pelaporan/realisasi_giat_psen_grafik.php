...
$real_1 = real_giat_sdbulan($th,$kdsatker,$kdgiat,1)/$Giat['RPHPAGU']*100 ;
$real_2 = real_giat_sdbulan($th,$kdsatker,$kdgiat,2)/$Giat['RPHPAGU']*100 ;
$real_3 = real_giat_sdbulan($th,$kdsatker,$kdgiat,3)/$Giat['RPHPAGU']*100 ;
$real_4 = real_giat_sdbulan($th,$kdsatker,$kdgiat,4)/$Giat['RPHPAGU']*100 ;
$real_5 = real_giat_sdbulan($th,$kdsatker,$kdgiat,5)/$Giat['RPHPAGU']*100 ;
$real_6 = real_giat_sdbulan($th,$kdsatker,$kdgiat,6)/$Giat['RPHPAGU']*100 ;
$real_7 = real_giat_sdbulan($th,$kdsatker,$kdgiat,7)/$Giat['RPHPAGU']*100 ;
$real_8 = real_giat_sdbulan($th,$kdsatker,$kdgiat,8)/$Giat['RPHPAGU']*100 ;
$real_9 = real_giat_sdbulan($th,$kdsatker,$kdgiat,9)/$Giat['RPHPAGU']*100 ;
$real_10 = real_giat_sdbulan($th,$kdsatker,$kdgiat,10)/$Giat['RPHPAGU']*100 ;
$real_11 = real_giat_sdbulan($th,$kdsatker,$kdgiat,11)/$Giat['RPHPAGU']*100 ;
$real_12 = real_giat_sdbulan($th,$kdsatker,$kdgiat,12)/$Giat['RPHPAGU']*100 ;
...
$graph->subtitle->Set('SKegiatan : '.trim(nm_giat($kdgiat)));
