<?php
	...
	$field = array("KDGIAT","KDOUTPUT","NMOUTPUT","SAT");
...
#Halaman yang akan ditampilkan untuk pertengahan?
	...
	$query = "SELECT COUNT(a.KDOUTPUT) as num FROM $table a JOIN m_kegiatan b ON a.KDGIAT = b.kdgiat WHERE b.kddept = '$kddept' AND kdunit = '$kdunit' AND (a.KDOUTPUT LIKE '%$cari%' OR a.NMOUTPUT LIKE '%$cari%' OR a.SAT LIKE '%$cari%' OR a.KDGIAT LIKE '%$cari%' OR b.nmgiat LIKE '%$cari%') ";
...
//	$query = "SELECT COUNT(*) as num FROM $table WHERE KDOUTPUT LIKE '%$cari%' OR NMOUTPUT LIKE '%$cari%' OR SAT LIKE '%$cari%' OR KDGIAT LIKE '%$cari%'";
	...
	$oList = mysql_query("SELECT a.KDGIAT, b.nmgiat, a.KDOUTPUT, a.NMOUTPUT, a.SAT FROM $table a JOIN m_kegiatan b ON a.KDGIAT = b.kdgiat WHERE b.kddept = '$kddept' AND kdunit = '$kdunit' AND (a.KDOUTPUT LIKE '%$cari%' OR a.NMOUTPUT LIKE '%$cari%' OR a.SAT LIKE '%$cari%' OR a.KDGIAT LIKE '%$cari%' OR b.nmgiat LIKE '%$cari%') LIMIT $start, $limit");
	...
	while($List = mysql_fetch_object($oList)) {
		...
		$ed[] = $ed_link."&kdgiat=".$List->$field[0]."&kdoutput=".$List->$field[1];
...
<div align="right">
	<form action="" method="get">
		...
		<a href="index.php?p=476">Reset</a>
	</form>
</div><br />
<font color="#CC3300" size="+1"><strong>Tahun Anggaran <?php echo $th ?></strong></font>
