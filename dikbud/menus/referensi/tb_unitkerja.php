<?php
	...
	$query = "SELECT COUNT(*) as num FROM $table WHERE nmunit LIKE '%$cari%' OR kdunit LIKE '%$cari%' OR sktunit LIKE '%$cari%' ";
	...
	$oList = mysql_query("SELECT * FROM $table WHERE nmunit LIKE '%$cari%' OR kdunit LIKE '%$cari%' OR sktunit LIKE '%$cari%' ORDER BY kdunit LIMIT $start, $limit");
			...
			foreach ($col[0] as $k=>$val) {
				...
				<tr class="<?php echo $class ?>">
				  ...
				  <td align="left" valign="top"><?php echo $col[3][$k] ?></td>
					...
					<td align="center" valign="top">
						<a href="<?php echo $del[$k] ?>&pagess=<?php echo $pagess ?>" title="Delete">
