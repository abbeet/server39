...
<table width="738" cellpadding="1" class="adminlist">
  <thead>
    <tr> 
      <th>Kode APBN</th>
      <th colspan="2"><strong>Nama Kegiatan</strong> / <font color="#FF0000">Output</font><br>
        <font color="#339900">Sub Output</font> / <font color="#3333FF">Komponen</font><br>
        <font color="#660066">Sub Komponen</font> / Akun</th>
      <th>Anggaran</th>
      <th>Blokir</th>
    </tr>
  </thead>
  <tbody>
    <tr class="<?php echo $class ?>"> 
      ...
      <td width="14%" align="right"><strong><?php echo number_format($Giat['blokir_giat'],"0",",",".") ?></strong></td>
    </tr>
    <?php 
...
?>
    <tr class="<?php echo $class ?>"> 
      ...
      <td colspan="2" align="left"><font color="#FF0000"><?php echo nm_output_th($th,$kdgiat.$Output['KDOUTPUT']) ?>&nbsp;</font></td>
    ...
    <tr class="<?php echo $class ?>"> 
      ...
      <td align="right"><?php echo number_format($Akun['blokir_akun'],"0",",",".") ?></td>
    </tr>
    <?php
		} # AKUN
		} # SUB KMPNEN
