	...
	{		
		if ($err != true) 
		{
			...
			if ($_FILES['spmind_1']['name'] != "")
			{
				...
				if(empty($row)){
					$sql = "INSERT INTO dt_fileupload_keu (kdfile , nama_file , tgl_upload , user_upload , type , kdsatker , keterangan) values
					       ('D_SPMIND_FRM' , '$filename' , '$tgl_upload' , '$xusername' , 'spm' , '$kdsatker' , 'File Realisasi SPM' )";				
					$query = mysql_query($sql) or die(mysql_error());
				}else{
					$sql = "UPDATE dt_fileupload_keu SET tgl_upload = '$tgl_upload', user_upload = '$xusername' WHERE type = 'spm' and kdfile = 'D_SPMIND_FRM' and kdsatker = '$kdsatker'";				
					$query = mysql_query($sql) or die(mysql_error());
				}
				//--------------------
			...
			if ($_FILES['spmind_2']['name'] != "")
			{
				...
				if(empty($row)){
					$sql = "INSERT INTO dt_fileupload_keu (kdfile , nama_file , tgl_upload , user_upload , type , kdsatker , keterangan) values
					       ('D_SPMIND_MYD' , '$filename' , '$tgl_upload' , '$xusername' , 'spm' , '$kdsatker' , 'File Realisasi SPM' )";				
					$query = mysql_query($sql) or die(mysql_error());
				}else{
					$sql = "UPDATE dt_fileupload_keu SET tgl_upload = '$tgl_upload', user_upload = '$xusername' WHERE type = 'spm' and kdfile = 'D_SPMIND_MYD' and kdsatker = '$kdsatker'";				
					$query = mysql_query($sql) or die(mysql_error());
				}
				//--------------------
			...
			if ($_FILES['spmind_3']['name'] != "")
			{
				...
				if(empty($row)){
					$sql = "INSERT INTO dt_fileupload_keu (kdfile , nama_file , tgl_upload , user_upload , type , kdsatker , keterangan) values
					       ('D_SPMIND_MYI' , '$filename' , '$tgl_upload' , '$xusername' , 'spm' , '$kdsatker' , 'File Realisasi SPM' )";				
					$query = mysql_query($sql) or die(mysql_error());
				}else{
					$sql = "UPDATE dt_fileupload_keu SET tgl_upload = '$tgl_upload', user_upload = '$xusername' WHERE type = 'spm' and kdfile = 'D_SPMIND_MYI' and kdsatker = '$kdsatker'";				
					$query = mysql_query($sql) or die(mysql_error());
				}
				//--------------------
			...
			if ($_FILES['spmmak_1']['name'] != "")
			{
				...
				if(empty($row)){
					$sql = "INSERT INTO dt_fileupload_keu (kdfile , nama_file , tgl_upload , user_upload , type , kdsatker , keterangan) values
					       ('D_SPMMAK_FRM' , '$filename' , '$tgl_upload' , '$xusername' , 'spm' , '$kdsatker' , 'File Realisasi SPM' )";				
					$query = mysql_query($sql) or die(mysql_error());
				}else{
					$sql = "UPDATE dt_fileupload_keu SET tgl_upload = '$tgl_upload', user_upload = '$xusername' WHERE type = 'spm' and kdfile = 'D_SPMMAK_FRM' and kdsatker = '$kdsatker'";				
					$query = mysql_query($sql) or die(mysql_error());
				}
				//--------------------
			...
			if ($_FILES['spmmak_2']['name'] != "")
			{
				...
				if(empty($row)){
					$sql = "INSERT INTO dt_fileupload_keu (kdfile , nama_file , tgl_upload , user_upload , type , kdsatker , keterangan) values
					       ('D_SPMMAK_MYD' , '$filename' , '$tgl_upload' , '$xusername' , 'spm' , '$kdsatker' , 'File Realisasi SPM' )";				
					$query = mysql_query($sql) or die(mysql_error());
				}else{
					$sql = "UPDATE dt_fileupload_keu SET tgl_upload = '$tgl_upload', user_upload = '$xusername' WHERE type = 'spm' and kdfile = 'D_SPMMAK_MYD' and kdsatker = '$kdsatker'";				
					$query = mysql_query($sql) or die(mysql_error());
				}
				//--------------------
			...
			if ($_FILES['spmmak_3']['name'] != "")
			{
				...
				if(empty($row)){
					$sql = "INSERT INTO dt_fileupload_keu (kdfile , nama_file , tgl_upload , user_upload , type , kdsatker , keterangan) values
					       ('D_SPMMAK_MYI' , '$filename' , '$tgl_upload' , '$xusername' , 'spm' , '$kdsatker' , 'File Realisasi SPM' )";				
					$query = mysql_query($sql) or die(mysql_error());
				}else{
					$sql = "UPDATE dt_fileupload_keu SET tgl_upload = '$tgl_upload', user_upload = '$xusername' WHERE type = 'spm' and kdfile = 'D_SPMMAK_MYI' and kdsatker = '$kdsatker'";				
					$query = mysql_query($sql) or die(mysql_error());
				}
				//--------------------
...
-->
  ...
  <table cellspacing="1" class="admintable">
    ...
    <tr> 
      ...
      &nbsp;<span class="style1">[ 
        File : D_SPMIND.FRM]</span> </td>
    </tr>
    <tr> 
      <td class="key">&nbsp;</td>
      <td> <input type="file" name="spmind_2" size="60" /> &nbsp;<span class="style1">[ 
        File : D_SPMIND.MYD]</span> </td>
    </tr>
    <tr> 
      <td class="key">&nbsp;</td>
      <td> <input type="file" name="spmind_3" size="60" /> &nbsp;<span class="style1">[ 
        File : D_SPMIND.MYI]</span> </td>
    </tr>
    <tr> 
      <td class="key">File Realisasi Akun</td>
      <td> <input type="file" name="spmmak_1" size="60" /> 
      &nbsp;<span class="style1">[ 
        File : D_SPMMAK.FRM]</span> </td>
    </tr>
    <tr> 
      <td class="key">&nbsp;</td>
      <td> <input type="file" name="spmmak_2" size="60" /> &nbsp;<span class="style1">[ 
        File : D_SPMMAK.MYD]</span> </td>
    </tr>
    <tr> 
      <td class="key">&nbsp;</td>
      <td> <input type="file" name="spmmak_3" size="60" /> &nbsp;<span class="style1">[ 
        File : D_SPMMAK.MYI]</span> </td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
...
<?php
	...
	{
		case '1':
	$sql = "select * from dt_fileupload_keu WHERE type = 'spm' and left(kdfile,1) = 'D' order by kdsatker";
			break;
		case '3':
	$sql = "select * from dt_fileupload_keu WHERE type = 'spm' and kdsatker = '$kdsatker' and left(kdfile,1) = 'D' order by kdsatker";
			break;
		case '4':
	$sql = "select * from dt_fileupload_keu WHERE type = 'spm' and kdsatker = '$kdsatker' and left(kdfile,1) = 'D' order by kdsatker";
			break;
