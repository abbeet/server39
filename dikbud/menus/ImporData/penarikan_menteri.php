<?php
	...
	$sql = "select sum(RPHPAGU) as RPHPAGU,
					...
					sum(JML11) as JML11,
					sum(JML12) as JML12
					from $table WHERE THANG='$th' group by THANG";
...
<table width="407" cellpadding="1" class="adminlist">
  <thead>
    <tr> 
      ...
      <th colspan="2">Kementerian</th>
      <th rowspan="2">Anggaran</th>
      <th colspan="13">Rencana Penarikan Bulan Ke</th>
    </tr>
    <tr>
      <th colspan="2">Jenis Belanja</th> 
      <th>1</th>
      <th>2</th>
      <th>3</th>
      <th>4</th>
  ...
  <tbody>
    <tr class="<?php echo $class ?>"> 
      <td width="10%" align="center"><strong><?php echo $kddept ?></strong></td>
      <td colspan="2" align="left"><strong><?php echo strtoupper(nm_unit($kdmenteri)) ?></strong></td>
	...
	<?php 
		$sql = "select JNSBELANJA, sum(RPHPAGU) as RPHPAGU,
					...
					sum(JML11) as JML11,
					sum(JML12) as JML12
					from $table WHERE THANG='$th' group by JNSBELANJA";
