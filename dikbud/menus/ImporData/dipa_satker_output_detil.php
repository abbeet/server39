...
<table width="738" cellpadding="1" class="adminlist">
  <thead>
    <tr> 
      <th width="8%">Kode APBN</th>
      <th colspan="2"><font color="#FF0000">Output</font><br>
...
?>
    ...
    <tr class="<?php echo $class ?>"> 
      <td align="center">&nbsp;</td>
      <td width="5%" align="center"><?php echo $Akun['KDAKUN'] ?>&nbsp;</td>
      <td width="61%" align="left"><?php echo nm_akun($Akun['KDAKUN']) ?>&nbsp;</td>
      <td align="right"><?php echo number_format($Akun['pagu_akun'],"0",",",".") ?></td>
      <td align="right"><font color="#FF0000"><?php echo number_format($Akun['blokir_akun'],"0",",",".") ?>&nbsp;</font></td>
    </tr>
    <?php
		} # AKUN
		} # SUB KMPNEN
