<?php
	if(isset($_POST['q']))
	{
		...
		$q = $_POST['q']; #echo $q."<br>";
		$tgl_refresh = $_POST['tgl_refresh']; #echo $tgl_refresh."<br>";
		$user_refresh = $_POST['user_refresh']; #echo $user_refresh."<br>";
		...
		#else echo "Sambungan RKAKL gagal!";
		
		switch ($q)
		{
			case "D_OUTPUT":
				mysql_query("DELETE FROM d_outputx WHERE THANG = '".$ta."'");
				...
				while ($row = odbc_fetch_row($Output))
				{
					...
					$sql = "INSERT INTO d_outputx (THANG, KDSATKER, KDDEPT, KDUNIT, KDPROGRAM, KDGIAT, KDOUTPUT, VOL) VALUES ('$THANG', '$KDSATKER', '$KDDEPT', '$KDUNIT', '$KDPROGRAM', '$KDGIAT', '$KDOUTPUT', '$VOL')";
					mysql_query($sql);
			...
			case "D_SOUTPUT":
				mysql_query("DELETE FROM d_soutputx WHERE THANG = '".$ta."'");
				...
				while ($row = odbc_fetch_row($SOutput))
				{
					...
					$sql = "INSERT INTO d_soutputx (THANG, KDSATKER, KDDEPT, KDUNIT, KDPROGRAM, KDGIAT, KDOUTPUT, KDSOUTPUT, URSOUTPUT, VOLSOUT) VALUES ('$THANG', '$KDSATKER', '$KDDEPT', '$KDUNIT', '$KDPROGRAM', '$KDGIAT', '$KDOUTPUT', '$KDSOUTPUT', '$URSOUTPUT', '$VOLSOUT')";
					mysql_query($sql);
			...
			case "D_KMPNEN":
				mysql_query("DELETE FROM d_kmpnenx WHERE THANG = '".$ta."'");
				...
				while ($row = odbc_fetch_row($Kmpnen))
				{
					...
					$sql = "INSERT INTO d_kmpnenx (THANG, KDSATKER, KDDEPT, KDUNIT, KDPROGRAM, KDGIAT, KDOUTPUT, KDSOUTPUT, KDKMPNEN, URKMPNEN) VALUES ('$THANG', '$KDSATKER', '$KDDEPT', '$KDUNIT', '$KDPROGRAM', '$KDGIAT', '$KDOUTPUT', '$KDSOUTPUT', '$KDKMPNEN', '$URKMPNEN')";
					mysql_query($sql);
			...
			case "D_SKMPNEN":
				mysql_query("DELETE FROM d_skmpnenx WHERE THANG = '".$ta."'");
				...
				while ($row = odbc_fetch_row($SKmpnen))
				{
					...
					$sql = "INSERT INTO d_skmpnenx (THANG, KDSATKER, KDDEPT, KDUNIT, KDPROGRAM, KDGIAT, KDOUTPUT, KDSOUTPUT, KDKMPNEN, KDSKMPNEN, URSKMPNEN) VALUES ('$THANG', '$KDSATKER', '$KDDEPT', '$KDUNIT', '$KDPROGRAM', '$KDGIAT', '$KDOUTPUT', '$KDSOUTPUT', '$KDKMPNEN', '$KDSKMPNEN', '$URSKMPNEN')";
					mysql_query($sql);
			...
			case "D_AKUN":
				mysql_query("DELETE FROM d_akunx WHERE THANG = '".$ta."'");
				...
				while ($row = odbc_fetch_row($Akun))
				{
					...
					$sql = "INSERT INTO d_akunx (THANG, KDSATKER, KDDEPT, KDUNIT, KDPROGRAM, KDGIAT, KDOUTPUT, KDSOUTPUT, KDKMPNEN, KDSKMPNEN, KDAKUN) VALUES ('$THANG', '$KDSATKER', '$KDDEPT', '$KDUNIT', '$KDPROGRAM', '$KDGIAT', '$KDOUTPUT', '$KDSOUTPUT', '$KDKMPNEN', '$KDSKMPNEN', '$KDAKUN')";
					mysql_query($sql);
			...
			case "D_ITEM":
				mysql_query("DELETE FROM d_itemx WHERE THANG = '".$ta."'");
