...
<table width="787" cellpadding="1" class="adminlist">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td align="right"><font color="#009933"><strong><?php echo number_format($real_menteri_spm,"0",",",".") ?></strong></font></td>
      <td align="center"><font color="#009933"><strong><?php echo number_format($real_menteri_spm/$pagu_menteri*100,"2",",",".") ?></strong></font></td>
      <td align="right"><font color="#009933"><strong><?php echo number_format($real_menteri_sp2d,"0",",",".") ?></strong></font></td>
      <td align="center"><font color="#009933"><strong><?php echo number_format($real_menteri_sp2d/$pagu_menteri*100,"2",",",".") ?></strong></font></td>
      <td align="center"><font color="#009933"><strong><?php echo number_format($real_menteri_spm-$real_menteri_sp2d,"0",",",".") ?></strong></font></td>
      <td align="center"><font color="#009933"><strong><?php echo number_format(($real_menteri_spm-$real_menteri_sp2d)/$pagu_menteri*100,"2",",",".") ?></strong></font></td>
      <td align="center">&nbsp;</td>
    </tr>
<?php
		}  # AKHIR IF
