...
<table width="787" cellpadding="1" class="adminlist">
  <thead>
    <tr> 
      ...
      <th colspan="3">File ADK RKAKL Terakhir </th>
...
<?php
    ...
    <?php
			...
			foreach ($col[0] as $k=>$val) {
				...
				$kdsatker = $col[0][$k] ;
			$sql = "select * from dt_fileupload_keu WHERE type = 'adk_rkakl' and kdsatker = '$kdsatker' order by nama_file desc";
			$aSatker = mysql_query($sql);
    ...
    <tr class="<?php echo $class ?>"> 
      ...
      <td align="center">
	  <a href="index.php?p=608&kdsatker=<?php echo $col[0][$k] ?>&th=<?php echo $th ?>" title="Data ADK RKAKL Detil"><font size="1"> 
        ADK>></font></a>	  </td>
    </tr>
    <?php
		}
