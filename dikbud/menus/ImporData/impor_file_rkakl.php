...
-->
	...
	{
		case '1':
			$query = mysql_query("select KDSATKER, left(NMSATKER,60) as namasatker from t_satker WHERE KDDEPT = '023' AND KDUNIT = '15' AND left(NMSATKER,5) <> 'DINAS' order by KDSATKER");
			break;
		case '3':
