<?php
	...
	$sql = "select sum(RPHPAGU) as RPHPAGU,
					...
					sum(JML11) as JML11,
					sum(JML12) as JML12
					from $table WHERE THANG='$th' AND KDSATKER='$kdsatker' group by KDSATKER";
...
<table width="407" cellpadding="1" class="adminlist">
  <thead>
    <tr> 
      ...
      <th colspan="2" rowspan="2">Nama Satker</th>
  ...
  <tbody>
    <tr class="<?php echo $class ?>"> 
      <td width="10%" align="center"><strong><?php echo $kdsatker ?></strong></td>
      <td colspan="2" align="left"><strong><?php echo nm_satker($kdsatker) ?></strong></td>
	...
	<?php 
		$sql = "select JNSBELANJA, sum(RPHPAGU) as RPHPAGU,
					...
					sum(JML11) as JML11,
					sum(JML12) as JML12
					from $table WHERE THANG='$th' AND KDSATKER='$kdsatker' group by JNSBELANJA";
