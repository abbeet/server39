<?php
	...
	$sql = "select sum(JUMLAH) as pagu_giat , sum(RPHBLOKIR) as blokir_giat from $table WHERE THANG='$th' AND KDSATKER='$kdsatker' and KDGIAT='$kdgiat' group by KDGIAT";
...
<table width="738" cellpadding="1" class="adminlist">
  <thead>
    <tr> 
      <th>Kode APBN</th>
      <th colspan="5"><strong>Nama Kegiatan</strong> / <font color="#FF0000">Output</font><br>
        <font color="#339900">Sub Output</font> / <font color="#3333FF">Komponen</font><br>
        <font color="#660066">Sub Komponen</font> / <font color="#663300">Akun</font><br />
		Item</th>
      <th>Anggaran</th>
      <th>Blokir</th>
    </tr>
  ...
  <tbody>
    <tr class="<?php echo $class ?>"> 
      <td width="6%" align="center"><strong><?php echo $kdgiat ?></strong></td>
      <td colspan="5" align="left"><strong><?php echo nm_giat($kdgiat) ?></strong></td>
      <td width="13%" align="right"><strong><?php echo number_format($Giat['pagu_giat'],"0",",",".") ?></strong></td>
      <td width="13%" align="right"><strong><?php echo number_format($Giat['blokir_giat'],"0",",",".") ?></strong</td>
    </tr>
    <?php 
